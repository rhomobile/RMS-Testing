...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createMethodsProxy(Mediaplayer, [
        ...
        , { methodName: 'stop', nativeName: 'stop', valueCallbackIndex: 0 }
          ...
          // function(/* optional function */ oResult)
        , { methodName: 'getAllRingtones', nativeName: 'getAllRingtones', valueCallbackIndex: 0 }
    ...
    // === Mediaplayer default instance support ===
        ...
        Mediaplayer.getId = function() {
            if (null == currentDefaultID) {
                currentDefaultID = Mediaplayer.getDefaultID();
            }
            return currentDefaultID;
        }

        // === Mediaplayer default instance properties ===

        rhoUtil.createPropsProxy(Mediaplayer, [
        ], apiReq, function(){ return this.getId(); });

        // === Mediaplayer default instance methods ===
