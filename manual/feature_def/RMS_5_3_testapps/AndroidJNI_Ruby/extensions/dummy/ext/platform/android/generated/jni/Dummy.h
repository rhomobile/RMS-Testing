...
protected:
    ...
    static const char* const ENABLESTRING_TASK_CLASS;
    static jclass s_clsenableStringTask;
    static jmethodID s_midenableStringTask;
    static const char* const ENABLEINT_TASK_CLASS;
    static jclass s_clsenableIntTask;
    static jmethodID s_midenableIntTask;
    static const char* const ENABLEBOOL_TASK_CLASS;
    static jclass s_clsenableBoolTask;
    static jmethodID s_midenableBoolTask;
    static const char* const ENABLEFLOAT_TASK_CLASS;
    static jclass s_clsenableFloatTask;
    static jmethodID s_midenableFloatTask;
    static const char* const ENABLEARRAY_TASK_CLASS;
    static jclass s_clsenableArrayTask;
    static jmethodID s_midenableArrayTask;
...
public:
    ...
    void enableString(const T& argsAdapter, MethodResultJni& result)
    {
        LOG(TRACE) + "enableString";
        ...
        jhobject jhTask = env->NewObject(s_clsenableStringTask, s_midenableStringTask,
                    jhObject.get(), 
                    jhfiringInterval.get(),
                    static_cast<jobject>(result));
    ...
    void enableInt(const T& argsAdapter, MethodResultJni& result)
    {
        LOG(TRACE) + "enableInt";
        ...
        jhobject jhTask = env->NewObject(s_clsenableIntTask, s_midenableIntTask,
                    jhObject.get(), 
                    jhfiringInterval.get(),
                    static_cast<jobject>(result));
    ...
    void enableBool(const T& argsAdapter, MethodResultJni& result)
    {
        LOG(TRACE) + "enableBool";
        ...
        jhobject jhTask = env->NewObject(s_clsenableBoolTask, s_midenableBoolTask,
                    jhObject.get(), 
                    jhfiringInterval.get(),
                    static_cast<jobject>(result));
    ...
    void enableFloat(const T& argsAdapter, MethodResultJni& result)
    {
        LOG(TRACE) + "enableFloat";
        ...
        jhobject jhTask = env->NewObject(s_clsenableFloatTask, s_midenableFloatTask,
                    jhObject.get(), 
                    jhfiringInterval.get(),
                    static_cast<jobject>(result));
    ...
    void enableArray(const T& argsAdapter, MethodResultJni& result)
    {
        LOG(TRACE) + "enableArray";
        ...
        jhobject jhTask = env->NewObject(s_clsenableArrayTask, s_midenableArrayTask,
                    jhObject.get(), 
                    jhfiringInterval.get(),
                    static_cast<jobject>(result));
