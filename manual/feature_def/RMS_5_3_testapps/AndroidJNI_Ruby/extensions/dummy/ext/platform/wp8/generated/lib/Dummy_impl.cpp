...
void CDummyImpl::enableString(int firingInterval, CMethodResult& oResult)
{
    try {
        _runtime->enableString(firingInterval, ref new CMethodResultImpl((int64)&oResult));
    } catch (Platform::Exception^ e) {
        LOG(ERROR) + rho::common::convertStringAFromWP8(e->ToString());
    }
}

void CDummyImpl::enableInt(int firingInterval, CMethodResult& oResult)
{
    try {
        _runtime->enableInt(firingInterval, ref new CMethodResultImpl((int64)&oResult));
    } catch (Platform::Exception^ e) {
        LOG(ERROR) + rho::common::convertStringAFromWP8(e->ToString());
    }
}

void CDummyImpl::enableBool(int firingInterval, CMethodResult& oResult)
{
    try {
        _runtime->enableBool(firingInterval, ref new CMethodResultImpl((int64)&oResult));
    } catch (Platform::Exception^ e) {
        LOG(ERROR) + rho::common::convertStringAFromWP8(e->ToString());
    }
}

void CDummyImpl::enableFloat(int firingInterval, CMethodResult& oResult)
{
    try {
        _runtime->enableFloat(firingInterval, ref new CMethodResultImpl((int64)&oResult));
    } catch (Platform::Exception^ e) {
        LOG(ERROR) + rho::common::convertStringAFromWP8(e->ToString());
    }
}

void CDummyImpl::enableArray(int firingInterval, CMethodResult& oResult)
{
    try {
        _runtime->enableArray(firingInterval, ref new CMethodResultImpl((int64)&oResult));
    } catch (Platform::Exception^ e) {
        LOG(ERROR) + rho::common::convertStringAFromWP8(e->ToString());
    }
}
