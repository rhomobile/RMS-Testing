...
namespace DummyImpl
{
    public class Dummy : DummyBase
    {
        ...
        public override void enable(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enableString(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enableInt(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enableBool(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enableFloat(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enableArray(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }
