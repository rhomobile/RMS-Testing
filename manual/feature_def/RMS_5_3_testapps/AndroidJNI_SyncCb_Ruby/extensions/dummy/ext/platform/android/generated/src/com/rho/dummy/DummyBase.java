...
public class DummyBase extends RhoApiObject {
    ...
    public static class enableStringTask implements Runnable {
        private IDummy mApiObject; 
        private int firingInterval;
        private IMethodResult mResult;

        public enableStringTask(IDummy obj, 
                int firingInterval, 
                IMethodResult result) {
            this.mApiObject = obj; 
            this.firingInterval = firingInterval;
    ...
    public static class enableIntTask implements Runnable {
        private IDummy mApiObject; 
        private int firingInterval;
        private IMethodResult mResult;

        public enableIntTask(IDummy obj, 
                int firingInterval, 
                IMethodResult result) {
            this.mApiObject = obj; 
            this.firingInterval = firingInterval;
    ...
    public static class enableBoolTask implements Runnable {
        private IDummy mApiObject; 
        private int firingInterval;
        private IMethodResult mResult;

        public enableBoolTask(IDummy obj, 
                int firingInterval, 
                IMethodResult result) {
            this.mApiObject = obj; 
            this.firingInterval = firingInterval;
    ...
    public static class enableFloatTask implements Runnable {
        private IDummy mApiObject; 
        private int firingInterval;
        private IMethodResult mResult;

        public enableFloatTask(IDummy obj, 
                int firingInterval, 
                IMethodResult result) {
            this.mApiObject = obj; 
            this.firingInterval = firingInterval;
    ...
    public static class enableArrayTask implements Runnable {
        private IDummy mApiObject; 
        private int firingInterval;
        private IMethodResult mResult;

        public enableArrayTask(IDummy obj, 
                int firingInterval, 
                IMethodResult result) {
            this.mApiObject = obj; 
            this.firingInterval = firingInterval;
