...
public:
    ...
    virtual void enable_Int(int firingInterval, rho::apiGenerator::CMethodResult& oResult);
    virtual void enable_str(int firingInterval, rho::apiGenerator::CMethodResult& oResult);
    virtual void enable_bool(int firingInterval, rho::apiGenerator::CMethodResult& oResult);
    virtual void enable_double(int firingInterval, rho::apiGenerator::CMethodResult& oResult);
