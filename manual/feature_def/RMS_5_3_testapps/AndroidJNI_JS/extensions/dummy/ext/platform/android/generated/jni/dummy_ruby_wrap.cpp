...
static VALUE Dummy_enable_Int(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    dummy.enable_Int(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Dummy_enable_Int(argc, argv, id);
}
...
static VALUE Dummy_enable_str(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    dummy.enable_str(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Dummy_enable_str(argc, argv, id);
}
...
static VALUE Dummy_enable_bool(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    dummy.enable_bool(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Dummy_enable_bool(argc, argv, id);
}
...
static VALUE Dummy_enable_double(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    dummy.enable_double(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Dummy_enable_double(argc, argv, id);
}
