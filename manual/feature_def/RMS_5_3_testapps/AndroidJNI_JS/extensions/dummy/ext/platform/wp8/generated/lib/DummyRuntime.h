...
namespace rhoruntime
{
    ...
    public:
        ...
        void enable_Int(int firingInterval, IMethodResult^ oResult);
        void enable_str(int firingInterval, IMethodResult^ oResult);
        void enable_bool(int firingInterval, IMethodResult^ oResult);
        void enable_double(int firingInterval, IMethodResult^ oResult);
