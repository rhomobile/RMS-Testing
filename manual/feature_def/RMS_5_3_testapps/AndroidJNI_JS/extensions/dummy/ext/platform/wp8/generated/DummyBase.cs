...
namespace DummyImpl
{
    abstract public class DummyBase : IDummyImpl
    {
        ...
        abstract public void enable_Int(int firingInterval, IMethodResult oResult);
        abstract public void enable_str(int firingInterval, IMethodResult oResult);
        abstract public void enable_bool(int firingInterval, IMethodResult oResult);
        abstract public void enable_double(int firingInterval, IMethodResult oResult);
