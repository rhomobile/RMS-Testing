...
namespace DummyImpl
{
    public class Dummy : DummyBase
    {
        ...
        public override void enable_Int(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enable_str(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enable_bool(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }

        public override void enable_double(int firingInterval, IMethodResult oResult)
        {
            // implement this method in C# here
        }
