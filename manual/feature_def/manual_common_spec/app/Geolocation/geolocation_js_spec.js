describe("Geolocation RUBY API Test", function() {
	...
	it("should setnotification and callback should fired within 3 sec Interval", function(){
		runs(function()
		{
			dispCurrentProcess(jasmine.getEnv().currentSpec.description);
			Ruby.call('Geolocation','setNotification');
    ...
    if (["ANDROID"].indexOf(Rho.System.platform) != -1) {
		it("should setnotification EX and callback should fired within 3 sec Interval and Speed, altitude and satelite should be shown", function(){
			runs(function()
			{
				dispCurrentProcess(jasmine.getEnv().currentSpec.description);
				Ruby.call('Geolocation','setNotificationEX');
