...
/*  function displayTestDescription(aString) {
    ...
    xdescribe('enumerateSupportedTypes method', function() {
    ...
    xdescribe('should getPrinterByID', function() {
        // find printer
    ...
    xdescribe('enumerateSupportedControlLanguages method', function() {
    ...
    if(!isWindowsMobilePlatform()) {
        ...
        xdescribe('stopSearch method', function() {
    ...
    xdescribe("Getting properties of the connected printer", function() {
	...
	xdescribe('negetive test case', function() {
        //var description = '';
        it('should connect', function() {
            doConnect();
        });
