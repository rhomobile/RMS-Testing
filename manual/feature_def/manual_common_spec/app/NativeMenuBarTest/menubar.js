...
{ label: 'Home',action:'Home',disabled:false},{label:'separator',action:'separator',disabled:false},{label:'Options',action:'Options',disabled:false},{label:'Log',action:'Log',disabled:false},{label:'Refresh',action:'Refresh',disabled:false},{label:'Exit',action:'Exit',disabled:false},{label:'Sync',action:'Sync',disabled:false},{label:'fullscreen',action:'fullscreen',disabled:false},{label:'Load a page',action:'/app/loading.html',disabled:false}
 ];
}
...
Rho.NativeMenubar.mainMenu = [
{ label: 'Home',action:'Home',disabled:false},{label:'Options',action:'Options',disabled:false},{label:'Log',action:'Log',disabled:true},{label:'Refresh',action:'Refresh',disabled:true},{label:'Exit',action:'Exit',disabled:false},{label:'Sync',action:'Sync',disabled:false},{label:'fullscreen',action:'fullscreen',disabled:false},{label:'Load a page',action:'/app/loading.html',disabled:false}
 ];
}
 
function menuJavascriptCall() {
Rho.NativeMenubar.mainMenu = [
{ label: 'Home',action:'Home',disabled:false},{label:'Options',action:'Options',disabled:false},{label:'Log',action:'Log',disabled:false},{label:'Refresh',action:'Refresh',disabled:false},{label:'Exit',action:'javascript:onQuit()',disabled:false},{label:'Sync',action:'Sync',disabled:false},{label:'fullscreen',action:'fullscreen',disabled:false}
 ];
...
{
Rho.NativeMenubar.mainMenu = [
{ label: 'Home',action:'Home',disabled:false},{label:'Options',action:'Options',disabled:false},{label:'Log',action:'Log',disabled:false},{label:'Refresh',action:'Refresh',disabled:false},{label:'Exit',action:'Exit',disabled:false},{label:'Sync',action:'Sync',disabled:false},{label:'fullscreen',action:'fullscreen',disabled:false}
 ];
