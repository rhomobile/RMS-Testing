...
describe("Signal Manual FD  Tests", function () {
  var statusCallback = function (args){
    ...
    it("VT298-001 |Signal showIcon color without any property |", function () {
        ...
        runs(function () {
            dispTestCaseRunning("Signal showIcon color without any property");
    ...
    it("VT298-002 |Signal showIcon left with 40 |", function () {

        runs(function () {
            dispTestCaseRunning("Watch the change in the position of signal icon");
    ...
    it("VT298-003 |Signal showIcon top with 40|", function () {
    ...
    it("VT298-008 |Signal showIcon layout with left|", function () {
    ...
    it("VT298-009 |Signal showIcon layout with right|", function () {
    ...
    it("VT298-010 |Signal showIcon layout with up|", function () {
    ...
    it("VT298-011 |Signal showIcon layout with down|", function () {
    ...
    it("VT298-0014|Signal showIcon color with #0000FF value|", function () {
        ...
        runs(function () {
            dispTestCaseRunning("Watch the change in the colour of signal icon");
    ...
    it("VT298-0016|Signal showIcon with all properties|", function () {

        runs(function () {
            dispTestCaseRunning("Watch the change in the properties  of signal icon");
    ...
    it("VT298-0017|Signal hideIcon |", function () {

        runs(function () {
            dispTestCaseRunning("Hide icon will hide the signal icon after 10 secs");
    ...
    it("VT298-0020|WlanStatus with default callback |", function () {
        ...
        runs(function () {
            dispTestCaseRunning("see whether all the return parameters are retrieved in callback and check whether event is fired for every 5 sec default");
    ...
    it("VT298-0021|stop firing wlan Status  |", function () {
        ...
        runs(function () {
            ...
            dispTestCaseRunning("see whether all the return parameters are retrieved in callback and check whether event is fired for every 5 sec default and after 15 sec no more event should be fired");
    ...
    it("VT298-0023|WlanStatus with changing the device proximity  to Router|", function () {
        ...
        runs(function () {
            dispTestCaseRunning("see whether all the return parameters are retrieved in callback and check whether the parameters are changing every 5 sec if you change the proximity to the server");
    ...
    it("VT298-0024|WlanStatus with default callback with disconnecting the profile |", function () {
        ...
        runs(function () {
            dispTestCaseRunning("Make sure u disconnect WLAN profile while running this test and check return parameters");
    ...
    it("VT298-0027|WlanStatus with 8 sec refresh interval |", function () {

        runs(function () {
            dispTestCaseRunning("see whether all the return parameters are retrieved in callback and check whether event is fired for every 8 sec ");
