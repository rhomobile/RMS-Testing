...
it("VT284-017|Battery showIcon all property|", function () {
          ...
          runs(function () {
              ...
              dispExpectedResult("battery icon should be shown with layout left and blue in conlor horizontal and vertical position at 20 and 40");
...
it("VT284-018|Battery showIcon all property with powerSupply|", function () {
          ...
          runs(function () {
              ...
              dispExpectedResult("battery icon should be shown with powersupply and layout left and blue in conlor horizontal and vertical position at 20 and 40");
            Rho.Battery.showIcon({left: 20,top: 40,layout:'left',color:'#FF0000'});
          });
          waitsFor(function () {
              return captured;
