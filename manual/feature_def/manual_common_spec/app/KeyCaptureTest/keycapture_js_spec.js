describe("KeyCapture Test", function() {
	...
	describe("captureKey, captureTrigger and remapKey Test", function() {
		...
		if (isApplePlatform())
		{
			it("VT289-012 | call captureKey  keyValue for " +VALUE_11+" and function callback |", function() {

				runs(function()
				{
					setObjective("VT289-012 | call captureKey keyValue for " +VALUE_11+" and function callback");
					setInstruction("Press hardware key " +VALUE_11);
					setExpected("Callback should fire with value " +TEST_11);
			...
			it("VT289-013 | call captureKey with keyValue for" +VALUE_13+" function callback |", function() {

				runs(function()
				{
					setObjective("VT289-013 | call captureKey keyValue for " +VALUE_13+"  function callback");
					setInstruction("Press hardware key " +VALUE_13);
					setExpected("Callback should fire with value " +TEST_13);
			...
			it("VT289-014 | call captureKey keyValue for " +VALUE_14+" and callback as Anynomous function |", function() {

				runs(function()
				{
					setObjective("VT289-014 | call captureKey keyValue for " +VALUE_14+" and callback as Anynomous function");
					setInstruction("Press hardware key " +VALUE_14);
					setExpected("Callback should fire with value " +TEST_14+" check for Callback to fire with value "+TEST_14);
			...
			it("VT289-020 | call captureKey with different callback for 2 different keys |", function() {
				...
				runs(function()
				{
					...
					setInstruction("Press " +VALUE_11+", Press numeric key " +VALUE_15);
					setExpected("2 different Callback should fire after pressing " +VALUE_11+" and " +VALUE_15);
			...
			it("VT289-021 | call captureKey twice, one with callback and other without callback |", function() {
				...
				runs(function()
				{
					...
					setInstruction("Press " +VALUE_15+", " +VALUE_21+"");
					setExpected("callback1 should fire after pressing " +VALUE_15+" and no callback should fire after pressing " +VALUE_21);
					Rho.KeyCapture.captureKey(true,TEST_15,capturekeycallback);
			...
			it("VT289-031 | call captureKey with no callback after setting "+ VALUE_11, function() {
				...
				runs(function()
				{
					...
					setInstruction("Textbox and press "+ VALUE_11);
					setExpected("No callback should fire after pressing" +VALUE_11);
					Rho.KeyCapture.captureKey(false,TEST_11,capturekeycallback);
					Rho.KeyCapture.captureKey(true,TEST_11);
				});
