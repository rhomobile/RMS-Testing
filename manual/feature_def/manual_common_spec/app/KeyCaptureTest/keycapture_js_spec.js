		...
		if (isWindowsMobileOrAndroidPlatform())
		{
			it("VT289-039 | call remapKey with "+hardwareKeysTest.testKey18.description+" and "+ hardwareKeysTest.testKey13.description, function() {
				...
				runs(function()
				{
					...
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey18.string,hardwareKeysTest.testKey13.string);
				});
				...
				{		
					...
					runs(function() {
					expect("pass").toEqual(document.getElementById("actResult").innerHTML);
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey18.string, null);
					});	
				});
			});
			...
			it("VT289-041 | call remapKey with "+hardwareKeysTest.testKey11.description+" and null |", function() {
				...
				runs(function()
				{
					...
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey11.string,hardwareKeysTest.testKey14.string);
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey11.string, null);
				});
			...
			it("VT289-044 | call capturekey after remapKey |", function() {
				...
				runs(function()
				{
					...
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey11.string,hardwareKeysTest.testKey13.string);
					Rho.KeyCapture.captureKey(true,hardwareKeysTest.testKey11.string,capturekeycallback);					
				});
			...
			it("VT289-045 | call capturekey after remapKey and callback to fire with both key |", function() {
				...
				runs(function()
				{
					...
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey14.string,hardwareKeysTest.testKey21.string);
					Rho.KeyCapture.captureKey(true,hardwareKeysTest.testKey21.string,capturekeycallback);					
				});
				...
				{		
					...
					runs(function() {
					expect("pass").toEqual(document.getElementById("actResult").innerHTML);
					Rho.KeyCapture.remapKey(hardwareKeysTest.testKey14.string, null);
					Rho.KeyCapture.captureKey(true,hardwareKeysTest.testKey21.string);
					});	
				});
			});
