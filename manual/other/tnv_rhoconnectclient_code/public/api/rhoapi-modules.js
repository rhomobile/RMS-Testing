...
(function ($, rho, rhoUtil) {
    ...
    // === Battery static methods ===
        ...
        Battery['batteryStatus'] = function(/* const rho::Hashtable<rho::String, rho::String>& */ propertyMap, /* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
        ...
        Battery['stopBatteryStatus'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'stopBatteryStatus',
                
                valueCallbackIndex: 0
            });
        };
    
        Battery['smartBatteryStatus'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'smartBatteryStatus',
                persistentCallbackIndex: 0,
                valueCallbackIndex: 2
            });
        };
    
        Battery['showIcon'] = function(/* const rho::Hashtable<rho::String, rho::String>& */ propertyMap, /* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'showIcon',
        ...
        Battery['hideIcon'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'hideIcon',
...
(function ($, rho, rhoUtil) {
    ...
    // === KeyState static methods ===
        ...
        KeyState['showStates'] = function(/* const rho::Hashtable<rho::String, rho::String>& */ propertyMap, /* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'showStates',
        ...
        KeyState['hideStates'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'hideStates',
...
(function ($, rho, rhoUtil) {
    ...
    rhoUtil.createPropsProxy(Signal.prototype, {
    }, apiReq);
    ...
    // === Signal static properties ===

    rhoUtil.createPropsProxy(Signal, {
       'refreshInterval': 'rw'
    }, apiReq);
    ...
    // === Signal static methods ===
        ...
        Signal['wlanStatus'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'wlanStatus',
        ...
        Signal['stopWlanStatus'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'stopWlanStatus',
                
                valueCallbackIndex: 0
            });
        };
    
        Signal['showIcon'] = function(/* const rho::Hashtable<rho::String, rho::String>& */ propertyMap, /* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'showIcon',
        ...
        Signal['hideIcon'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'hideIcon',
    ...
    // === Signal default instance support ===

    

    rhoUtil.namespace(moduleNS, Signal);
...
(function ($, rho, rhoUtil) {
    ...
    // === CardReader instance methods ===
        ...
        CardReader.prototype['open'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'open',
        ...
        CardReader.prototype['close'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'close',
        ...
        CardReader.prototype['getProperty'] = function(/* const rho::String& */ propertyName, /* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'getProperty',
        ...
        CardReader.prototype['getProperties'] = function(/* const rho::Vector<rho::String>& */ arrayofNames, /* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'getProperties',
        ...
        CardReader.prototype['getAllProperties'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'getAllProperties',
        ...
        CardReader.prototype['setProperty'] = function(/* const rho::String& */ propertyName, /* const rho::String& */ propertyValue, /* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'setProperty',
        ...
        CardReader.prototype['setProperties'] = function(/* const rho::Hashtable<rho::String, rho::String>& */ propertyMap, /* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'setProperties',
        ...
        CardReader.prototype['clearAllProperties'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: this.getId(),
                args: arguments,
                method: 'clearAllProperties',
    ...
    // === CardReader static methods ===
        ...
        CardReader['enumerate'] = function(/* optional function */ oResult) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method: 'enumerate',
    ...
    // === CardReader default instance support ===
        ...
        CardReader['getDefault'] = function () {
        ...
        CardReader['getDefaultID'] = function (valueCallback) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method:'getDefaultID',
        ...
        CardReader['setDefaultID'] = function (id) {
            return apiReq({
                instanceId: '0',
                args: arguments,
                method:'setDefaultID'
