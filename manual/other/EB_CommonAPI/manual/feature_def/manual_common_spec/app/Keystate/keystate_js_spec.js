...
describe("Key State Test", function() {
	...
	it("VT281-0851 | KeyState showStates with right to 50 |", function() {
		...
		dispCurrentProcess("VT281-0851 | KeyState showStates with right to 50<br>Press Shift, Alt, Control, Function, Caps, Num lock and Orange key");
			EB.KeyState.showStates({"right":50})
			setTimeout(function() {
				displayflag = true;
			}, 10000);
		});
	...
	it("VT281-0857 | KeyState showStates with width to 100 |", function() {
		runs(function()
		{
			...
			EB.KeyState.showStates({"width":100})
			setTimeout(function() {
				displayflag = true;
			}, 10000);
		});
	...
	it("VT281-0860 | KeyState showStates with height to 100 |", function() {
		runs(function()
		{
			...
			EB.KeyState.showStates({"height":150})
			setTimeout(function() {
				displayflag = true;
			}, 10000);
		});
	...
	it("VT281-0863 | KeyState showStates with all properties |", function() {
		runs(function()
		{
			...
			EB.KeyState.showStates({'right':100,'top':150,'height':200,'width':250})
			setTimeout(function() {
				displayflag = true;
			}, 10000);
		});
