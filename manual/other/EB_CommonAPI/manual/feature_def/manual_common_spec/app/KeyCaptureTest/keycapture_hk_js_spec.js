		...
		if (isWindowsMobilePlatform())
		{
			...
			it("VT289-003 | set homeKeyValue to Uparrow |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x26';
				});
			...
			it("VT289-004 | set homeKeyValue to alphabet key a |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x41';
				});
			...
			it("VT289-005 | set homeKeyValue to alphabet key C (caps) |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x43';
				});
			...
			it("VT289-006 | set homeKeyValue to symbol key # |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x23';
				});
...
//trigger key can not bet set as Homekey
			xit("VT289-007 | set homeKeyValue to trigger key |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0';
					EB.KeyCapture.homeKeyValue = '0x200';
				});
			...
			it("VT289-033 | call captureKey after setting homeKeyValue|", function() {
				...
				{		
					...
					expect("pass").toEqual(document.getElementById("actResult").innerHTML);
					EB.KeyCapture.homeKeyValue = 'Disabled';
					EB.KeyCapture.captureKey(true,'0x0D');
					});	
				});
...
////trigger key can not bet set as Homekey
			xit("VT289-034 | call captureTrigger after setting homeKeyValue |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x66';
					EB.KeyCapture.captureKey(true,'0x66',triggercallback);
				});
				...
				{		
					...
					expect("pass").toEqual(document.getElementById("actResult").innerHTML);
					EB.KeyCapture.homeKeyValue = 'Disabled';
					EB.KeyCapture.captureKey(true,'0x66');
					});	
				});
			...
			it("VT289-042 | call remapKey after setting homeKeyValue |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x33';
					EB.KeyCapture.remapKey('0x33','0x34');
				});
			...
			it("VT289-043 | call remapKey after setting homeKeyValue and navigate to homepage |", function() {
				...
				runs(function()
				{
					...
					EB.KeyCapture.homeKeyValue = '0x36';
					EB.KeyCapture.remapKey('0x37','0x36');
				});
