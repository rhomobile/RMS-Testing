describe('Printer Zebra', function() {
    ...
    it('initialize before tests', function() {
        ...
        runs(function() {
            EB.Log.info("initialize ", "JSC");
            searchObject = runSearch({}, 30000);
            EB.Log.info("runned ", "JSC");
        });
            ...
            it(description, function() {
                ...
                runs(function() {
                    if (searchParamaters['printerType']) {
                        searchVals['printerType'] = EB.Printer.PRINTER_TYPE_ZEBRA;
                    }
                ...
                runs(function() {
                    ...
                    if (searchParamaters['timeout'] && !searchParamaters['deviceAddress'] && $('#dev_conn_type').val() != EB.PrinterZebra.CONNECTION_TYPE_BLUETOOTH) {
...
//        });
    ...
    describe('requestState method', function() {
        ...
        it("Request printer state for list of parameters", function() {
            ...
            runs(function() {
                expect(requeststate_callbackValue.status).toEqual(EB.PrinterZebra.PRINTER_STATUS_SUCCESS);
            });
        });
