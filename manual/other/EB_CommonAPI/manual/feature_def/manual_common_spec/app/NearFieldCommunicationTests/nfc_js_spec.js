describe('Near Field Communication Tests', function () {
    ...
    describe("Adapter specs without engine activation", function () {
        ...
        it("Property \"supported\" should return true if NFC supported on this device", function () {
            ...
            runs(function () {
                spec.addResult("Property \"supported\"", EB.NFC.Adapter.supported);
                spec.displayResults();
        ...
        it("Property \"version\" should return version of the NFC engine", function () {
            ...
            runs(function () {
                spec.addResult("Property \"version\"", EB.NFC.Adapter.version);
                spec.displayResults();
                spec.waitForResponse();
            });
        });
        ...
        it("Method \"activate\" should activate NFC engine", function () {
            ...
            runs(function () {
                EB.NFC.Adapter.activate();
                spec.addResult("Property \"isActive\"", EB.NFC.Adapter.isActive);
                spec.displayResults();
                spec.waitForResponse();
            });
        });
    ...
    describe("Adapter specs with engine activation", function () {
        ...
        it("Method \"reset\" should reset configuration of NFC engine", function () {
            ...
            runs(function () {
                EB.NFC.Adapter.pollingTimeout = 10;
                EB.NFC.Adapter.passkey = "123456";
                EB.NFC.Adapter.reset();
                spec.addResult("Property \"pollingTimeout\"", EB.NFC.Adapter.pollingTimeout);
                spec.addResult("Property \"passKey\"", EB.NFC.Adapter.passkey);
                spec.displayResults();
                spec.waitForResponse();
            });
        });
        ...
        it("Get device capabilities", function () {
            ...
            runs(function () {
                var capabilities = EB.NFC.Adapter.getDeviceInfo();
        ...
        it("ConfigChangeHandler should fires on pollingTimeout changing", function () {
            ...
            EB.NFC.Adapter.setConfigChangeHandler(function (anObject) {
        ...
        it("Pairing devices via Bluetooth", function () {
            ...
            runs(function () {
                flag = false;
                EB.NFC.Adapter.passkey = "123456";
                EB.NFC.Adapter.btConnect(function (object) {
        ...
        it('Tag reading', function () {
            ...
            EB.NFC.Adapter.setTagDetectionHandler([], function (anObject) {
                try {
                    var tag = EB.NFC.Tag.getTagById(anObject["tagId"]);
        ...
        it('Message reading', function () {
            ...
            EB.NFC.Adapter.setMessageHandler(function (anObject) {
                var message = EB.NFC.Message.getMessageById(anObject["messageId"]);
                try {
        ...
        it("Method \"exchangeData\" should exchnage data with Tag", function () {
            ...
            runs(function () {
                var tag = EB.NFC.Tag.getTagById(tagID);
        ...
        it('Message writing', function () {
            ...
            runs(function () {
                ...
                // if tag.isReadOnly == false
                if(tag.isNdef == false) {tag.formatNDEF();}
                var message = EB.NFC.Message.create();
                var record = EB.NFC.Record.create();
                record.type = 1;
