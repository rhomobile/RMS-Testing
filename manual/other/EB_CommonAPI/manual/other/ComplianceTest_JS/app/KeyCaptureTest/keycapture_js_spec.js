		...
		///////////////////////////////////////////////////////////////////////
			...
			it("VT200-0607 | call captureKey with keyValue for" +hardwareKeysTest.testKey11.description+" function callback |", function() {
				...
				runs(function()
				{
					...
					//var keyval1 = EB.KeyCapture.captureKey(true,hardwareKeysTest.testKey11.string);
			...
			if (isWindowsMobileOrAndroidPlatform() && EB.System.isMotorolaDevice == true) 
			{
				...
				it("VT200-0612 | call remapKey |", function() {
					...
					runs(function()
					{
						...
						EB.KeyCapture.remapKey(hardwareKeysTest.testKey18.string,hardwareKeysTest.testKey21.string);
					});
					...
					{		
						...
						runs(function() {
						expect("pass").toEqual(document.getElementById("actResult").innerHTML);
						EB.KeyCapture.remapKey(hardwareKeysTest.testKey18.string,'');
						});	
					});
