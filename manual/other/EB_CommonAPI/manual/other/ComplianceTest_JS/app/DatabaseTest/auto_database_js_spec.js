describe('Database JS API', function() {
	...
	describe('ST set', function() {
	    ...
	    it("VT287-1 |To Open a DatabaseEB.Database| ", function() {
	    ...
	    xit("VT287-18 | Try openeing database without passing dbPartition parameter | ", function() {
	        var description;
	        try {
	            db = new EB.Database(EB.Application.databaseFilePath('local'));
	        } catch (e) {
	            description = e.description;
	        }
	    ...
	    xit("VT287-19 | Try openeing database with invalid dbpath and invalid Dbparameter | ", function() {
	        var description;
	        try {
	            db = new EB.Database('/fooo/fooo/fooo', '@$$%%@#');
	        } catch (e) {
	            description = e.description;
	        }
	    ...
	    xit("VT287-20| Try openeing database with invalid DbParameter with special characters | ", function() {
	        var description;
	        try {
	            var getmodelpath = EB.Application.get_model_path('app', 'Settings');
	            db = new EB.Database(File.join(getmodelpath, 'test'), '@#%^&*#');
	        } catch (e) {
	            description = e.description;
	        }
	        expect(description).toEqual('Error code: 14; Message: unable to open database file');
	    ...
	    it("VT287-21 |Opening Database at predefined partition app|", function() {
	        db = new EB.Database(EB.Application.databaseFilePath('app'), 'app');
	    ...
	    it("VT287-22 |Opening Database at predefined partition user|", function() {
	        db = new EB.Database(EB.Application.databaseFilePath('user'), 'user');
	    ...
	    xit("VT287-26 | Try opening database with 256 character long Partition name | ", function() {
	        var dbName = File.join(EB.Application.get_model_path('app', 'Settings'), '');
	
	        var description;
	        try {
	            db = new EB.Database(dbName, 'deva');
	        } catch (e) {
	            description = e.description;
	        }
	    ...
	    it("VT287-31|Operating two db objects with diff path and diff Partition | ", function() {
	        db = new EB.Database(EB.Application.databaseFilePath('local'), 'local');
	        var db2 = new EB.Database(EB.Application.databaseFilePath('testDB2'), 'testDB2');
	    ...
	    xit("VT287-32|two db objects for the same db file and closing one instance of it  | ", function() {
	        db = new EB.Database(EB.Application.databaseFilePath('local'), 'local');
	        var db2 = new EB.Database(EB.Application.databaseFilePath('local'), 'local');
	...
	describe('SQLite3', function () {
	    ...
	    beforeEach(function() {
	        db = new EB.Database.SQLite3(EB.Application.databaseFilePath('local'), 'local');
	    });
