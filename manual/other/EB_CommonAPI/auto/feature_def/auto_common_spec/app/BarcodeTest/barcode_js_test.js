...
var getApplicableProperties = function (objScnType){
	...
	//Consumer Android
	if(isAndroid && EB.System.deviceName.indexOf('Motorola Solutions') == -1)
	{
		return;
	}
	...
	for (var i = 0; i < arr_scanner_property.length ; i++){
		...
		if((arr_scanner_property[i]['OSTypes'] == 'All') || (arr_scanner_property[i]['OSTypes'] == EB.System.platform)){
			...
			else if ((deviceScannerType == "2D Imager" || EB.System.oemInfo == "MC40") && isAndroid && arr_scanner_property[i]['notOnAndroidImager'] === true)//If it is the Android hardware Imager
			{
				//Dont add
			}
...
var isAndroid = (EB.System.platform == "ANDROID");
var isJB = (isAndroid && EB.System.osVersion.indexOf('4.') == 0);

var ENABLE_TIMEOUT_VALUE = (EB.System.platform == "ANDROID" ? 10 : 8000);