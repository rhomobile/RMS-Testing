...
function isAndroidPlatform() {
    return "ANDROID" == EB.System.platform;
}

function isApplePlatform() {
    return "APPLE" == EB.System.platform;
}

function isWindowsMobilePlatform() {
    return "WINDOWS" == EB.System.platform;
}

function isWindowsDesktopPlatform() {
    return "WINDOWS_DESKTOP" == EB.System.platform;
}

function isWindowsPhone8Platform() {
    return "WP8" == EB.System.platform;
}
