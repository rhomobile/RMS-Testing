...
//            %>"
            location.href = "http://192.168.6.18/pb3.x/scanner/ScannerTest/ScanProcess.asp?TestID=" + ODAXForm.testID.value + "&Actual=" +  newData + "&NextTC=" + ODAXForm.nextTC.value + "&Result=Pass&selScanner=" + ODAXForm.selScanner.value + "&deviceName=" + ODAXForm.deviceName.value + "&";
        }
        else 
        {
...
function markFail()
{
    ...
    //alert(ActVal);
    var str = "http://192.168.6.18/pb3.x/scanner/ScannerTest/ScanProcess.asp?TestID=" + ODAXForm.testID.value + "&Actual=" +  encodetxt + "&NextTC=" + ODAXForm.nextTC.value + "&Result=Fail&selScanner=" + ODAXForm.selScanner.value + "&deviceName=" + ODAXForm.deviceName.value + "&";
    //alert(str);
    location.href = "http://192.168.6.18/pb3.x/scanner/ScannerTest/ScanProcess.asp?TestID=" + ODAXForm.testID.value + "&Actual=" +  encodetxt + "&NextTC=" + ODAXForm.nextTC.value + "&Result=Fail&selScanner=" + ODAXForm.selScanner.value + "&deviceName=" + ODAXForm.deviceName.value + "&";
...
function skipTC()
{
    ...
    location.href = "http://192.168.6.18/pb3.x/scanner/ScannerTest/ScanProcess.asp?TestID=" + ODAXForm.testID.value + "&Actual=Test Case Skipped by User" + "&NextTC=" + ODAXForm.nextTC.value + "&Result=NT&selScanner=" + ODAXForm.selScanner.value + "&deviceName=" + ODAXForm.deviceName.value + "&";
}
...
function markNA()
{
    ...
    location.href = "http://192.168.6.18/pb3.x/scanner/ScannerTest/ScanProcess.asp?TestID=" + ODAXForm.testID.value + "&Actual=Test Case Marked as Indeterminate by User" + "&NextTC=" + ODAXForm.nextTC.value + "&Result=Indeterminate&selScanner=" + ODAXForm.selScanner.value + "&deviceName=" + ODAXForm.deviceName.value + "&";
}
...
function move()
{
    ...
    location.href = "http://192.168.6.18/pb3.x/scanner/ScannerTest/ScanProcess.asp?TestID=" + ODAXForm.testID.value + "&Actual=Barcode Not Scanned.Manually marked as Pass by User." + "&NextTC=" + ODAXForm.nextTC.value + "&Result=Pass&selScanner=" + ODAXForm.selScanner.value + "&deviceName=" + ODAXForm.deviceName.value + "&";
}
