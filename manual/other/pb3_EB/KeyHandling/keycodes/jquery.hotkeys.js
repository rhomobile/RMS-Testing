...
(function(jQuery){
    jQuery.hotkeys = {
        ...
        specialKeys: {
            ...
            120: "f9", 121: "f10", 122: "f11", 123: "f12", 144: "numlock", 145: "scroll", 188: ",", 190: ".", 191: "/", 224: "meta"
        },
        shiftNums: {
            "`": "~", "1": "!", "2": "@", "3": "#", "4": "$", "5": "%", "6": "^", "7": "&",
            "8": "*", "9": "(", "0": ")", "-": "_", "=": "+", ";": ": ", "'": "\"", ",": "<",
    ...
    function keyHandler( handleObj ) {
        ...
        handleObj.handler = function( event ) {
            ...
            if (jQuery.hotkeys.global === false) {
            ...
            // TODO: Need to make sure meta works consistently across platforms
