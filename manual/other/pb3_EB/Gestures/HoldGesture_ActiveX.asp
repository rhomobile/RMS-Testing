...
<body onload="interval();">
    <form name="frmGes" id="frmGes" action="">
         ...
         <input type="hidden" name="centerx" id="centerx" value="<%=Request.QueryString("txtcenterx")%>">
         <input type="hidden" name="centery" id="centery" value="<%=Request.QueryString("txtcentery")%>">
         <input type="hidden" name="radius" id="radius" value="<%=Request.QueryString("txtradius")%>">
         <input type="hidden" name="delay" id="delay" value="<%=Request.QueryString("txtdelay")%>">
         <input type="hidden" name="interval" id="interval" value="<%=Request.QueryString("txtinterval")%>">
...
NumberOfGestures= document.frmGes.Number.value;
    ...
    {
     //alert("1");
    objgeneric.InvokeMETAFunction("gesture-detected", "url('http://192.168.6.18/NEON/Navigate.html?ID=%s&COUNT=%s')");
    }
