(function(){
	var pbTest = function(){
		...
		pbTestObj.testCases = [
		{
				...
				"testToPerform":function(){
					alarm.set();
					alarm.interval = "00-00-20";
					alarm.repeat = "true";
					alarm.alarmTriggered = 'doAlarm()';
					main.displayResult("wait for alarm trigger event..");
					setTimeout(function(){
						alarm.clear();
						main.displayResult("Alarm Cleared");
					},33000);
				},
				"FinalResult":""
			},{
				...
				"testToPerform":function(){
					...
					newDate = d.getFullYear() + "-" + newMonth + "-" + newDate1 + "t" + d.getHours() + "-" + (d.getMinutes() + 1) + "-" + "-" + "00-00-00";
					alarm.time = newDate; //"2015-02-11t05-52-00-00-00";
					alarm.set();
					alarm.alarmTriggered = 'doAlarm()';
					main.displayResult("Wait for alarm trigger event.. @ " + newDate);
				},
				"FinalResult":""	
			},{
				"VTID":"VT187-1368",
				...
				"testToPerform":function(){
					application.applicationEvent = 'applicationStateHandler(%json)';
					application.minimize();
					setTimeout(function(){
						application.restore();	
					},5000);
				...
				"testToPerform":function(){
					application.versionEvent = 'versionHandler(%json)';
				...
				"PreCondition":[],
				"Steps":["Attach a PowerOn event with file url.","PowerOnEvent:url('http://10.233.85.82:9099/app/DeviceApplication/offline.html')","Suspend the device","Resume the device"],
				"ExpectedOutcome":["On suspend/ resume, RE apps should navigate to specified offline local page"],
				"testToPerform":function(){
					powerOn.powerOnEvent="url('http://10.233.85.82:9099/app/DeviceApplication/offline.html')"; 
				},
				"FinalResult":""		
			},{
				"VTID":"VT187-1492",
				...
				"testToPerform":function(){
					screenOrientation.screenOrientationEvent = 'screenOrienCB(%json)';
				...
				"PreCondition":[],
				"Steps":["Keep the SetVolume parameter value to 0xFFFF.","Play the Wav file using playWave method..","Place alarm5.wav in application folder of the device"],
