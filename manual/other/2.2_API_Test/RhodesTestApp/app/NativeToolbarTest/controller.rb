...
if !defined?( RHO_WP7 )      
  ...
  def set_toolbar_lable
    ...
    toolbar = [
          {:action => :back, :lable => 'BBack'},
          {:action => :home, :lable => 'HHome'},
          {:action => :forward, :lable => 'FForword'}
    ]
    #NativeBar.create(Rho::RhoApplication::TOOLBAR_TYPE, :buttons => toolbar, :background_color => 0x00004F)
    Rho::NativeToolbar.create(:buttons => toolbar, :background_color => 0x00004F)
    $tabbar_active = false
  ...
  def set_toolbar_iconlable
    ...
    toolbar = [
          {:action => :back, :icon => '/public/images/bar/back_btn.png', :lable => 'Back'},
          {:action => :home, :icon => '/public/images/bar/colored_btn.png', :lable => 'Home'},
          {:action => :forward,:icon => '/public/images/bar/forward_btn.png', :lable => 'Forword'}
    ]
    #NativeBar.create(Rho::RhoApplication::TOOLBAR_TYPE, :buttons => toolbar, :background_color => 0x00004F)
    Rho::NativeToolbar.create(:buttons => toolbar, :background_color => 0x00004F)
    $tabbar_active = false
