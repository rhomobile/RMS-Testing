...
@interface rb_NativeBridgeTest_testApi_caller_params : NSObject
...
+(rb_NativeBridgeTest_testApi_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult;

@end

@implementation rb_NativeBridgeTest_testApi_caller_params
...
+(rb_NativeBridgeTest_testApi_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    rb_NativeBridgeTest_testApi_caller_params* par = [[[rb_NativeBridgeTest_testApi_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
...
@interface rb_NativeBridgeTest_testApi_caller : NSObject {

}
+(rb_NativeBridgeTest_testApi_caller*) getSharedInstance;
+(void) testApi:(rb_NativeBridgeTest_testApi_caller_params*)caller_params;
+(void) testApi_in_thread:(rb_NativeBridgeTest_testApi_caller_params*)caller_params;
+(void) testApi_in_UI_thread:(rb_NativeBridgeTest_testApi_caller_params*)caller_params;

@end

static rb_NativeBridgeTest_testApi_caller* our_NativeBridgeTest_testApi_caller = nil;

@implementation rb_NativeBridgeTest_testApi_caller

+(rb_NativeBridgeTest_testApi_caller*) getSharedInstance {
    if (our_NativeBridgeTest_testApi_caller == nil) {
        our_NativeBridgeTest_testApi_caller = [[rb_NativeBridgeTest_testApi_caller alloc] init];
    }
    return our_NativeBridgeTest_testApi_caller;
}

-(void) command_testApi:(rb_NativeBridgeTest_testApi_caller_params*)caller_params {
...
+(void) testApi:(rb_NativeBridgeTest_testApi_caller_params*)caller_params {
    [[rb_NativeBridgeTest_testApi_caller getSharedInstance] command_testApi:caller_params];
}

+(void) testApi_in_thread:(rb_NativeBridgeTest_testApi_caller_params*)caller_params {
    [[rb_NativeBridgeTest_testApi_caller getSharedInstance] performSelectorInBackground:@selector(command_testApi:) withObject:caller_params];
}

+(void) testApi_in_UI_thread:(rb_NativeBridgeTest_testApi_caller_params*)caller_params {
    [[rb_NativeBridgeTest_testApi_caller getSharedInstance] performSelectorOnMainThread:@selector(command_testApi:) withObject:caller_params waitUntilDone:NO];
}
...
VALUE rb_NativeBridgeTest_testApi_Obj(int argc, VALUE *argv, id<INativeBridgeTestSingleton>objItem) {
    ...
    if ((callbackURL != nil) || (callbackMethod != 0)) {
        ...
        [rb_NativeBridgeTest_testApi_caller testApi_in_thread:[rb_NativeBridgeTest_testApi_caller_params makeParams:params_array _item:objItem _methodResult:methodResult]];
        ...
        [rb_NativeBridgeTest_testApi_caller testApi:[rb_NativeBridgeTest_testApi_caller_params makeParams:params_array _item:objItem _methodResult:methodResult]];
...
VALUE rb_s_NativeBridgeTest_testApi(int argc, VALUE *argv) {

    id<INativeBridgeTestFactory> factory = [NativeBridgeTestFactorySingleton getNativeBridgeTestFactoryInstance];
    id<INativeBridgeTestSingleton> singleton = [factory getNativeBridgeTestSingleton];
    return rb_NativeBridgeTest_testApi_Obj(argc, argv, singleton);
