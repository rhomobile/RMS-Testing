...
@interface NativeBridgeTest_testApi_caller_params : NSObject
...
+(NativeBridgeTest_testApi_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult;

@end

@implementation NativeBridgeTest_testApi_caller_params
...
+(NativeBridgeTest_testApi_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    NativeBridgeTest_testApi_caller_params* par = [[[NativeBridgeTest_testApi_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
...
@interface NativeBridgeTest_testApi_caller : NSObject {

}
+(NativeBridgeTest_testApi_caller*) getSharedInstance;
+(void) testApi:(NativeBridgeTest_testApi_caller_params*)caller_params;
+(void) testApi_in_thread:(NativeBridgeTest_testApi_caller_params*)caller_params;
+(void) testApi_in_UI_thread:(NativeBridgeTest_testApi_caller_params*)caller_params;

@end

static NativeBridgeTest_testApi_caller* our_NativeBridgeTest_testApi_caller = nil;

@implementation NativeBridgeTest_testApi_caller

+(NativeBridgeTest_testApi_caller*) getSharedInstance {
    if (our_NativeBridgeTest_testApi_caller == nil) {
        our_NativeBridgeTest_testApi_caller = [[NativeBridgeTest_testApi_caller alloc] init];
    }
    return our_NativeBridgeTest_testApi_caller;
}

-(void) command_testApi:(NativeBridgeTest_testApi_caller_params*)caller_params {
    ...
    [objItem testApi:(NSArray*)[params objectAtIndex:0] hashHashStr:(NSDictionary*)[params objectAtIndex:1] hashArrStr:(NSDictionary*)[params objectAtIndex:2] arrArrStr:(NSArray*)[params objectAtIndex:3] methodResult:methodResult ];
    [caller_params.methodResult release];
    [caller_params release];
}
...
+(void) testApi:(NativeBridgeTest_testApi_caller_params*)caller_params {
    [[NativeBridgeTest_testApi_caller getSharedInstance] command_testApi:caller_params];
}

+(void) testApi_in_thread:(NativeBridgeTest_testApi_caller_params*)caller_params {
    [[NativeBridgeTest_testApi_caller getSharedInstance] performSelectorInBackground:@selector(command_testApi:) withObject:caller_params];
}

+(void) testApi_in_UI_thread:(NativeBridgeTest_testApi_caller_params*)caller_params {
    [[NativeBridgeTest_testApi_caller getSharedInstance] performSelectorOnMainThread:@selector(command_testApi:) withObject:caller_params waitUntilDone:NO];
}
...
rho::String js_NativeBridgeTest_testApi_Obj(rho::json::CJSONArray& argv, id<INativeBridgeTestSingleton>objItem, const rho::String& strCallbackID, const rho::String& strJsVmID, const rho::String& strCallbackParam) {
    ...
    [methodResult setMethodSignature:@"NativeBridgeTest::testApi"];

    
    static RHO_API_PARAM rho_api_params_param0[] = { {RHO_API_HASH, 0, 0, 0, 0 } };
    static RHO_API_PARAM rho_api_params_param3_param0[] = { {RHO_API_STRING, 0, 0, 0, 0 } };
    static RHO_API_PARAM rho_api_params_param3[] = { {RHO_API_ARRAY, 0, 0, 1, rho_api_params_param3_param0 } };
    static RHO_API_PARAM rho_api_params[] = { {RHO_API_ARRAY, 0, "arrHashStr", 1, rho_api_params_param0 }, {RHO_API_HASH, 0, "hashHashStr", 0, 0 }, {RHO_API_HASH, 0, "hashArrStr", 0, 0 }, {RHO_API_ARRAY, 0, "arrArrStr", 1, rho_api_params_param3 } };
    ...
    for (int i = 0; i < (4); i++) {
        if (argc > i) {
            ...
            // TODO: Handle CMethodResultError
            if (params[i] == nil) {
                NSLog(@"NativeBridgeTest::testApi parameter %d is nil!", i);
                rho::String resValue = rho::String("\"result\":null,\"error\":\"Method parameter is nil!\"");
                return resValue;
            }
        }
    ...
    if (method_receive_callback) {
        ...
        [NativeBridgeTest_testApi_caller testApi_in_thread:[NativeBridgeTest_testApi_caller_params makeParams:params_array _item:objItem _methodResult:methodResult]];
        ...
        [NativeBridgeTest_testApi_caller testApi:[NativeBridgeTest_testApi_caller_params makeParams:params_array _item:objItem _methodResult:methodResult]];
...
rho::String js_s_NativeBridgeTest_testApi(const rho::String& strObjID, rho::json::CJSONArray& argv, const rho::String& strCallbackID, const rho::String& strJsVmID, const rho::String& strCallbackParam) {
    ...
    id<INativeBridgeTestFactory> factory = [NativeBridgeTestFactorySingleton getNativeBridgeTestFactoryInstance];
    id<INativeBridgeTestSingleton> singleton = [factory getNativeBridgeTestSingleton];
    return js_NativeBridgeTest_testApi_Obj(argv, singleton, strCallbackID, strJsVmID, strCallbackParam);
