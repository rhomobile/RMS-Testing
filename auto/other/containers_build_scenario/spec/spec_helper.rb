...
def initiate_build_wmce
	...
	Open3.popen2e('rho device:wm:production_with_prebuild_binary') do |stdin, stdout_and_stderr, wait_thr|
		begin
...
def initiate_build_android
	...
	Open3.popen2e('rho device:android:production_with_prebuild_binary') do |stdin, stdout_and_stderr, wait_thr|
		begin
	    while line = stdout_and_stderr.readline
			$buffer << line
	    end
...
def initiate_build_ios
	...
	Open3.popen2e('rho device:iphone:production_with_prebuild_binary') do |stdin, stdout_and_stderr, wait_thr|
		begin
	    while line = stdout_and_stderr.readline
			$buffer << line
	    end
