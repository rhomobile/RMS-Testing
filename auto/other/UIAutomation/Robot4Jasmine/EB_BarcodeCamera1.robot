...
precondition
    waitTimeCapture    300
    startPath    Configuration/Applications/Application/General,StartPage,<StartPage value="http://127.0.0.1:8082/app/Barcode/specRunner_camera1.html" name="Menu"/>
...
STTL-116980 Barcode VT282-2001 call getProperties with sync callback and hash 
    [Documentation]
    [Tags]    Android
    readResult    VT282-2001 call getProperties with sync callback and hash 

STTL-116981 Barcode VT282-2002 call getProperties with anonymous callback and hash
    [Documentation]
    [Tags]    Android
    readResult    VT282-2002 call getProperties with anonymous callback and hash

STTL-116982 Barcode VT282-2000 call getProperties without callback
    [Documentation]
    [Tags]    Android
    readResult    VT282-2000 call getProperties without callback

STTL-116983 Barcode VT282-2004 call getProperty with sync callback and property
    [Documentation]
    [Tags]    Android
    readResult    VT282-2004 call getProperty with sync callback and property

STTL-116984 Barcode VT282-2005 call getProperty with anonymous callback and property
    [Documentation]
    [Tags]    Android
    readResult    VT282-2005 call getProperty with anonymous callback and property

STTL-116985 Barcode VT282-2003 call getProperty without callback
    [Documentation]
    [Tags]    Android
    readResult    VT282-2003 call getProperty without callback

STTL-116986 Barcode Disable
    [Documentation]
    [Tags]    Android
    readResult    Disable

STTL-116987 Barcode Enumerate Scanner callback as function
    [Documentation]
    [Tags]    Android
    readResult    Enumerate Scanner callback as function

STTL-116988 Barcode Enumerate Scanner with anonymous function as callback
    [Documentation]
    [Tags]    Android
    readResult    Enumerate Scanner with anonymous function as callback

STTL-116989 Barcode Enumerate Scanners without callback Synchronous Access
    [Documentation]
    [Tags]    Android
    readResult    Enumerate Scanners without callback Synchronous Access
