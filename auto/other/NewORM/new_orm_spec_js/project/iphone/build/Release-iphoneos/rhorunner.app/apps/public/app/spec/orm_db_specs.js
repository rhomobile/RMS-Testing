describe("ORM Db Reset Specs", function() {
  ...
  xit("Call databaseFullReset(true) should reset client info databaseFullReset tables",function(){
  ...
  xit("Call databaseFullReset(false) should not reset client info databaseFullReset tables",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    var client_id = userDB.executeSql("Select * from client_info");
    expect(client_id[0].client_id).toEqual("7");
  ...
  xit("should reset client info databaseFullReset tables of all partitions",function(){
    if (useNewOrm) {
  ...
  xit("Call databaseFullReset(false,false) should not reset client info and local models ",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    var client_id = userDB.executeSql("Select * from client_info");
    expect(client_id[0].client_id).toEqual("7");
  ...
  xit("Call databaseFullReset(true,true) should reset client info and local models ",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    var client_id = userDB.executeSql("Select * from client_info");
    expect(client_id[0].client_id).toEqual("7");
  ...
  xit("should reset client info databaseFullReset tables",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
  ...
  xit("should reset client info databaseFullReset tables with undefined params",function(){
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
        model.setModelProperty("price","float","");
  ...
  xit("should reset client info databaseFullReset tables with no params",function(){
    if (useNewOrm) {
      var Product = function(model){
        model.fixed_schema =true;
        model.setModelProperty("name","string","");
  ...
  xit("should reset object_values and not sources table if set databaseFullResetAndLogout",function(){
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
        model.setModelProperty("price","float","");
  ...
  xit("should delete all records only from selected models fixedschema databaseFullResetEx",function(){
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
        model.setModelProperty("price","float","");
  ...
  xit("should delete all records only from selected models propertyBag databaseFullResetEx",function(){
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
        model.setModelProperty("price","float","");
  ...
  xit("should reset client_info table if set databaseFullResetEx",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
  ...
  xit("Call databaseFullResetEx with Model name as Hash and reset_client_info as false and reset_local_models to false",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
  ...
  xit("Call databaseFullResetEx with Model name as Hash and reset_client_info as false",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
  ...
  xit("Call databaseFullResetEx with Model name as Hash and reset_client_info as false and reset_local_models to true",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
  ...
  xit("should do nothing if localdb and localdb flag set to false",function(){
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
        model.setModelProperty("price","float","");
  ...
  xit("should reset client and local db if databaseFullclientResetAndLogout",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
  ...
  xit("call databaseLocalReset without having any local model | Should not removed data from synced database",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    if (useNewOrm) {
      var Product = function(model){
        model.enable("sync");
  ...
  xit("call databaseLocalReset with changes in local model | Should removed local model data",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
  ...
  xit("call databaseLocalReset with changes in both local and user model | Should removed local model data",function(){
    userDB.executeSql("INSERT INTO CLIENT_INFO (client_id) VALUES(7)");
    if (useNewOrm) {
      var Product = function(model){
        model.setModelProperty("name","string","");
  ...
  xit("Call haveLocalChanges without having any model",function(){
    expect(Rho.ORM.haveLocalChanges()).toEqual(false);
  });

  xit("should return true if a model objects have local changes for sync haveLocalChanges",function(){
    expect(Rho.ORM.haveLocalChanges()).toEqual(false);
  ...
  xit("should load source from table if it exists",function(){
