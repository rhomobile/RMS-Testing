...
var imagerType = "";
	...
	imagerEnum[imagerEnum.length] = [["VT187-0169","Enumerate Imager Using Javascript"],
		["imager","imagerEnumEvent","JSONimagerEnumEvent(%json)"],
		["imager","enumerate","method"]
	];

	imagerEnum[imagerEnum.length] = [["VT187-0170","Enumerate Imager Using JSON Event"],
	...
	imageTransfer[imageTransfer.length] = [["VT187-0235","Imager Event of JSON Object type"],
		["imager","destination","url('ftp://192.168.6.18/Received/imageinQFTP.bmp')"],
...
function generateArrayWithImgType(arrImgType){
	...
	imageTransfer[imageTransfer.length] = [["VT187-0208","Destnation to file system"],
		...
		["imager","lamp","on"],
		["imager","aim","on"],
		["imager","destination","url('file://\\Temp\\CapturedImageTemp.bmp')"],
	...
	imageTransfer[imageTransfer.length] = [["VT187-0209","Destination to FTP"],
		...
		["imager","lamp","on"],
		["imager","aim","on"],
		["imager","destination","url('ftp://192.168.6.18/Received/imageInFTP.bmp')"],
		["imager","username","ftpadmin"],
		["imager","password","ftpadmin"],
		["imager","imagerEvent","JSimagerEvent('%s')"],
		["imager","enabled",arrImgType],
...
imageTransfer[imageTransfer.length] = [["VT187-0219","Destination as fully qualified URL FTP"],
	...
	["imager","lamp","on"],
	["imager","aim","on"],
	["imager","destination","url('ftp://ftpadmin:ftpadmin@192.168.6.18:21/Received/imageinQFTP.bmp')"],
	["imager","imagerEvent","JSimagerEvent('%s')"],
	["imager","enabled",arrImgType],
	["imager","capture","method"],
	["imager","disable","method"]
