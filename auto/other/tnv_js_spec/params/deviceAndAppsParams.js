...
backlightEvent[backlightEvent.length] = [["VT187-1401","Backlight-set backlightSettingsEvent-json"],
["backlight","backlightSettingsEvent","jsonBacklightSettingsEvent(%json)"],
["backlight","on","method"],
["backlight","getBacklightSettings","method"]
];
...
notificationEvent[notificationEvent.length] = [["VT187-1455","Enumerate Notification by using EnumNotificationsEvent - JSON"],
["notification","enumNotificationsEvent","jsonEnumNotificationsEvent(%json)"],
["notification","enumerate","method"]
];
...
screenOrientationSet[screenOrientationSet.length] = [["VT187-2267","ScreenOrientationEvent with JSON Notation"],
["screenOrientation","screenOrientationEvent","jsonScreenOrientationEvent(%json)"],
["screenOrientation","normal","method"]
];
...
timerEvent[timerEvent.length] = [["VT187-2326","Timeout event with JSON notation"],
["timer","timeout","jsonTimeout(%json)"],
["timer","interval","1000"],
["timer","start","method"]
];
...
applicationEvent[applicationEvent.length] = [["VT187-1380","Minimize with ApplicationEvent JSON"],
["application","applicationEvent","doStatejsonFunction(%json)"],
["application","minimize","method"]
];

applicationEvent[applicationEvent.length] = [["VT187-1380","Restore with ApplicationEvent JSON"],
["application","applicationEvent","doStatejsonFunction(%json)"],
["application","restore","method"]
];
...
applicationEvent[applicationEvent.length] = [["VT187-1383","Version Event(json)"],
