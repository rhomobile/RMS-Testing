describe("<ORM module specs>", function() {
    ...
    //     Rho.ORM.databaseFullResetEx(ary,false);
    ...
    // it("should export database by partition into zip",function(){

    // });

    // it("should import a database from zip to partition",function(){
