...
describe('Network JS API', function() {
	...
	var pxyHost = PROXY_HOST;
    var pxyPort = PROXY_PORT;
	var netHost = NET_HOST;
    var srvURL = "http://"+SERVER_HOST+":"+SERVER_PORT.toString();
    var httpsSrvURL = "https://"+SECURE_HOST+":"+SECURE_PORT.toString();
	var pxyURL = "http://"+PROXY_HOST+":"+PROXY_PORT.toString();
 ...
 if (netHost != null) {
  it('VT293-0089 | post with valide url with proxy enable using rhoconfi.txt or confix.xml', function() {
       var flag = false;
       var callbackCalled = false;
       var data = '';
	...
	it('VT293-0090 | get with callback with proxy enable using rhoconfi.txt or confix.xml', function() {
       var flag = false;
       var callbackCalled = false;
       var data = '';
	...
	it('VT293-0091 | download file from http with proxy enable using rhoconfi.txt or confix.xml', function() {
       var flag = false;
       var callbackCalled = false;
       var status = '';
       var fname = Rho.RhoFile.join(imagesDownloadFolder,"network_0049.jpg");
	 ...
	 it('VT293-0092 | download file with authentication properties with proxy enable using rhoconfi.txt or confix.xml', function() {
       var flag = false;
       var callbackCalled = false;
       var status = '';
    ...
    it('VT293-0093 | uploadFile to http with callback event with proxy enable using rhoconfi.txt or confix.xml', function() {
       var flag = false;
       var callbackCalled = false;
       var data = '';
       var status = '';
 ...
 it('VT293-0094 | uploadFile with autherisation properties with proxy enable using rhoconfi.txt or confix.xml', function() {
       var data = '';
       var callbackCalled = false;
       var status = '';
       var upload_file_callback = function (args){
 ...
 if (pxyHost != null && netHost == null) {
   ...
   Rho.System.httpProxyURI = pxyURL;
    it('VT293-0095 | post with valide url with proxy enable using system API', function() {
       var flag = false;
       var callbackCalled = false;
       var data = '';
	...
	it('VT293-0096 | get with callback with proxy enable using system API', function() {
       var flag = false;
       var callbackCalled = false;
       var data = '';
	...
	it('VT293-0097 | download file from http with callback event with proxy enable using system API', function() {
       var flag = false;
       var callbackCalled = false;
       var status = '';
       var fname = Rho.RhoFile.join(imagesDownloadFolder,"network_0049.jpg");
	 ...
	 it('VT293-0098 | download file with authentication properties with callback event with proxy enable using system API', function() {
       var flag = false;
       var callbackCalled = false;
       var status = '';
    ...
    it('VT293-0099 | uploadFile to http with callback event with proxy enable using system API', function() {
       var flag = false;
       var callbackCalled = false;
       var data = '';
       var status = '';
 ...
 it('VT293-0100 | uploadFile with autherisation properties with proxy enable using system API', function() {
       var data = '';
       var callbackCalled = false;
       var status = '';
       var upload_file_callback = function (args){
