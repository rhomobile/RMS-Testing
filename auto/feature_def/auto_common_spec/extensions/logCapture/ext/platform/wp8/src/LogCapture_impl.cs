...
namespace logCaptureImpl
{
    public class logCapture : IlogCaptureImpl
    {
        public logCapture()
        {
            var _runtime = new logCaptureRuntimeComponent(this);
        }
    ...
    public class logCaptureSingleton : IlogCaptureSingletonImpl
    {
        public logCaptureSingleton()
        {
            var _runtime = new logCaptureSingletonComponent(this);
        }
    ...
    public class logCaptureFactory : IlogCaptureFactoryImpl
    {
        public IlogCaptureImpl getImpl() {
            return new logCapture();
        }
        public IlogCaptureSingletonImpl getSingletonImpl() {
            return new logCaptureSingleton();
        }
    }
}
