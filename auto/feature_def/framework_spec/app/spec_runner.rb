...
#    MSpec.backtrace = true
  ...
  def set_default_files_for_auto_run
      config[:files] = []
         ...
         if Rho::System.platform == Rho::System::PLATFORM_ANDROID
          ...
          failed_specs_linux = [
            "spec/core/encoding/compatible_spec", #loop
            "spec/core/file/to_path_spec", #crash
            "spec/core/kernel/require_relative_spec", #loop
            "spec/core/kernel/require_spec", #loop
            "spec/core/thread/raise_spec", #loop
            "spec/library/cgi/out_spec", #crash
            "spec/core/method/parameters_spec", #crash,
            "spec/core/process/wait_spec", #loop
            "spec/core/process/wait2_spec", #loop
            "spec/core/process/waitall_spec", #loop
            "spec/library/net/ftp/chdir_spec", #crash
            "spec/rhomobile/RhoJSON_spec", #fail
            "spec/rhomobile/NetHttp_spec",
            "spec/language/break_spec",
            "spec/language/string_spec",
            "spec/language/predefined/data_spec",
            "spec/core/argf/argf_spec",
            "spec/core/argf/each_byte_spec",
            "spec/core/argf/bytes_spec",
            "spec/core/argf/each_codepoint_spec",
            "spec/core/argf/codepoints_spec",
            "spec/core/argf/to_s_spec",
            "spec/core/argf/skip_spec",
            "spec/core/argf/readpartial_spec",
            "spec/core/argf/file_spec",
            "spec/core/argf/pos_spec",
            "spec/core/argf/readchar_spec",
            "spec/core/argf/chars_spec",
            "spec/core/argf/seek_spec",
            "spec/core/argf/getc_spec",
            "spec/core/argf/argv_spec",
            "spec/core/argf/rewind_spec",
            "spec/core/argf/filename_spec",
            "spec/core/argf/closed_spec",
            "spec/core/argf/lineno_spec",
            "spec/core/argf/set_encoding_spec",
            "spec/core/argf/to_i_spec",
            "spec/core/argf/tell_spec",
            "spec/core/argf/each_char_spec",
            "spec/core/argf/to_a_spec",
            "spec/core/argf/close_spec",
            "spec/core/argf/each_spec",
            "spec/core/argf/path_spec",
            "spec/core/argf/readlines_spec",
            "spec/core/argf/each_line_spec",
            "spec/core/argf/binmode_spec",
            "spec/core/argf/eof_spec",
            "spec/core/argf/to_io_spec",
            "spec/core/argf/lines_spec",
            "spec/core/argf/read_spec",
            "spec/core/argf/fileno_spec",
            "spec/core/argf/gets_spec",
            "spec/core/argf/readline_spec",
            "spec/core/argf/read_nonblock_spec",
            "spec/core/array/inspect_spec",
            "spec/core/array/to_s_spec",
            "spec/core/array/pack/a_spec",
            "spec/core/array/pack/z_spec",
            ...
            "spec/core/module/prepend_features_spec",
            "spec/core/objectspace/define_finalizer_spec",
            "spec/core/process/daemon_spec",
            "spec/core/process/set_proctitle_spec",
            "spec/core/process/fork_spec",
            "spec/core/process/status/exited_spec",
            "spec/core/process/status/termsig_spec",
            "spec/core/process/status/signaled_spec",
            "spec/core/process/status/exitstatus_spec",
            "spec/core/process/status/pid_spec",
            "spec/core/process/status/success_spec",
            "spec/core/process/spawn_spec",
            "spec/core/process/setpriority_spec",
            "spec/core/process/kill_spec",
            "spec/core/process/exec_spec",
            "spec/core/range/inspect_spec",
            ...
            "spec/library/complex/numeric/im_spec",
            "spec/library/openssl/cipher_spec",
            "spec/library/openssl/x509/name/parse_spec",
            "spec/library/openssl/hmac/digest_spec",
            "spec/library/openssl/hmac/hexdigest_spec",
            "spec/library/openssl/random/pseudo_bytes_spec",
            "spec/library/openssl/random/random_bytes_spec",
            "spec/library/openssl/config/freeze_spec",
            "spec/library/prime/integer/from_prime_division_spec",
            "spec/library/prime/integer/prime_spec",
            "spec/library/prime/integer/each_prime_spec",
            "spec/library/prime/integer/prime_division_spec",
            ...
            "spec/library/socket/socket/pack_sockaddr_in_spec",
            "spec/library/socket/socket/gethostname_spec",
            "spec/library/zlib/crc_table_spec",
            "spec/library/zlib/gzipreader/read_spec",
            "spec/library/zlib/inflate/append_spec",
            "spec/library/zlib/inflate/inflate_spec",
            "spec/library/erb/new_spec",
  ...
  def set_default_files
    ...
    Dir.glob(specs) do |file|
      ...
      if ( System.get_property('platform') == 'WINDOWS' ) || ( System.get_property('platform') == 'WINDOWS_DESKTOP' ) || ( System.get_property('platform') == 'LINUX' )
        next if file =~ /\/execution_spec$/
        next if file =~ /\/data_spec$/
        next if file =~ /\/break_spec$/
        next if file =~ /\/string_spec$/
    ...
    core << 'argf' unless System.get_property('platform') == 'WINDOWS' || System.get_property('platform') == 'WINDOWS_DESKTOP' || System.get_property('platform') == 'LINUX'
    core << 'array'
    core << 'basicobject'
    core << 'bignum'
    core << 'binding'
    ...
    core << 'precision'
    core << 'proc'
    core << 'process' unless System.get_property('platform') == 'WINDOWS' || System.get_property('platform') == 'WINDOWS_DESKTOP' || System.get_property('platform') == 'LINUX'
    core << 'random'
    core << 'range'
    core << 'rational'
    core << 'regexp'
    core << 'signal'  unless System.get_property('platform') == 'WINDOWS' || System.get_property('platform') == 'WINDOWS_DESKTOP' || System.get_property('platform') == 'LINUX'
    core << 'string'
    core << 'struct'
    core << 'symbol'
    core << 'systemexit'
