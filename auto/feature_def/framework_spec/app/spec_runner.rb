      ...
      config[:files] = []
          ...
          Dir.glob(specs) do |file|
            ...
            if ( System.get_property('platform') == 'WINDOWS' ) || ( System.get_property('platform') == 'WINDOWS_DESKTOP' )
              ...
              next if file =~ /\/data_spec$/
              next if file =~ /\/break_spec$/
              next if file =~ /\/string_spec$/
            end
         ...
         if Rho::System.platform == Rho::System::PLATFORM_ANDROID
          ...
          failed_specs_Windows = [
              "spec/core/encoding/compatible_spec", #crash
              "spec/core/file/to_path_spec", #crash
              "spec/core/kernel/require_relative_spec", #loop
              "spec/core/kernel/require_spec", #loop
              "spec/core/thread/raise_spec", #loop
              "spec/library/cgi/out_spec", #crash

              "spec/language/break_spec",
              "spec/core/array/inspect_spec",
              "spec/core/array/pack/a_spec",
              "spec/core/array/pack/z_spec",
              "spec/core/basicobject/basicobject_spec",
              "spec/core/dir/chdir_spec",
              "spec/core/dir/chroot_spec",
              "spec/core/dir/close_spec",
              "spec/core/dir/delete_spec",
              "spec/core/dir/each_spec",
              "spec/core/dir/element_reference_spec",
              "spec/core/dir/exists_spec",
              "spec/core/dir/getwd_spec",
              "spec/core/dir/open_spec",
              "spec/core/dir/path_spec",
              "spec/core/dir/pos_spec",
              "spec/core/encoding/invalid_byte_sequence_error/destination_encoding_name_spec",
              "spec/core/encoding/name_spec",
              "spec/core/enumerable/all_spec",
              "spec/core/enumerable/collect_concat_spec",
              "spec/core/enumerable/collect_spec",
              "spec/core/enumerable/cycle_spec",
              "spec/core/enumerable/detect_spec",
              "spec/core/enumerable/drop_while_spec",
              "spec/core/enumerable/entries_spec",
              "spec/core/enumerable/find_all_spec",
              "spec/core/enumerable/first_spec",
              "spec/core/enumerable/include_spec",
              "spec/core/enumerable/inject_spec",
              "spec/core/enumerator/each_spec",
              "spec/core/enumerator/each_with_index_spec",
              "spec/core/enumerator/each_with_object_spec",
              "spec/core/enumerator/enum_for_spec",
              "spec/core/enumerator/feed_spec",
              "spec/core/enumerator/lazy/collect_concat_spec",
              "spec/core/enumerator/lazy/collect_spec",
              "spec/core/enumerator/lazy/drop_spec",
              "spec/core/enumerator/lazy/enum_for_spec",
              "spec/core/enumerator/lazy/find_all_spec",
              "spec/core/enumerator/new_spec",
              "spec/core/enumerator/next_spec",
              "spec/core/enumerator/rewind_spec",
              "spec/core/exception/backtrace_spec",
              "spec/core/exception/exception_spec",
              "spec/core/file/blockdev_spec",
              "spec/core/file/chardev_spec",
              "spec/core/file/delete_spec",
              "spec/core/file/directory_spec",
              "spec/core/file/executable_real_spec",
              "spec/core/file/executable_spec",
              "spec/core/file/exists_spec",
              "spec/core/file/expand_path_spec",
              "spec/core/file/file_spec",
              "spec/core/file/fnmatch_spec",
              "spec/core/file/ftype_spec",
              "spec/core/file/grpowned_spec",
              "spec/core/file/identical_spec",
              "spec/core/file/lstat_spec",
              "spec/core/file/new_spec",
              "spec/core/file/owned_spec",
              "spec/core/file/pipe_spec",
              "spec/core/file/readable_real_spec",
              "spec/core/file/readable_spec",
              "spec/core/file/read_spec",
              "spec/core/file/setgid_spec",
              "spec/core/file/setuid_spec",
              "spec/core/file/size_spec",
              "spec/core/file/socket_spec",
              "spec/core/file/stat/blockdev_spec",
              "spec/core/file/stat/ftype_spec",
              "spec/core/file/stat/sticky_spec",
              "spec/core/file/stat/symlink_spec",
              "spec/core/file/stat/world_readable_spec",
              "spec/core/file/stat/world_writable_spec",
              "spec/core/file/stat/writable_real_spec",
              "spec/core/file/stat/writable_spec",
              "spec/core/file/stat/zero_spec",
              "spec/core/fixnum/abs_spec",
              "spec/core/fixnum/case_compare_spec",
              "spec/core/fixnum/modulo_spec",
              "spec/core/float/abs_spec",
              "spec/core/float/angle_spec",
              "spec/core/float/case_compare_spec",
              "spec/core/float/divide_spec",
              "spec/core/float/fdiv_spec",
              "spec/core/float/modulo_spec",
              "spec/core/float/to_int_spec",
              "spec/core/hash/clear_spec",
              "spec/core/hash/delete_if_spec",
              "spec/core/hash/each_pair_spec",
              "spec/core/hash/element_set_spec",
              "spec/core/hash/eql_spec",
              "spec/core/hash/gte_spec",
              "spec/core/hash/gt_spec",
              "spec/core/hash/has_key_spec",
              "spec/core/hash/has_value_spec",
              "spec/core/hash/index_spec",
              "spec/core/hash/inspect_spec",
              "spec/core/hash/length_spec",
              "spec/core/hash/lte_spec",
              "spec/core/hash/merge_spec",
              "spec/core/hash/replace_spec",
              "spec/core/hash/values_at_spec",
              "spec/core/integer/ceil_spec",
              "spec/core/integer/next_spec",
              "spec/core/io/advise_spec",
              "spec/core/io/binwrite_spec",
              "spec/core/io/chars_spec",
              "spec/core/io/close_spec",
              ...
              "spec/core/io/stat_spec",
              "spec/core/io/syswrite_spec",
              "spec/core/kernel/abort_spec",
              "spec/core/kernel/Array_spec",
              "spec/core/kernel/caller_locations_spec",
              "spec/core/kernel/caller_spec",
              "spec/core/kernel/chomp_spec",
              "spec/core/kernel/chop_spec",
              "spec/core/kernel/clone_spec",
              "spec/core/kernel/Complex_spec",
              "spec/core/kernel/eql_spec",
              "spec/core/kernel/eval_spec",
              "spec/core/kernel/exec_spec",
              "spec/core/kernel/exit_spec",
              "spec/core/kernel/fork_spec",
              "spec/core/kernel/Hash_spec",
              "spec/core/kernel/is_a_spec",
              "spec/core/kernel/lambda_spec",
              "spec/core/kernel/load_spec",
              "spec/core/kernel/methods_spec",
              "spec/core/kernel/method_spec",
              "spec/core/kernel/not_match_spec",
              "spec/core/kernel/object_id_spec",
              "spec/core/kernel/private_methods_spec",
              "spec/core/kernel/protected_methods_spec",
              "spec/core/kernel/public_methods_spec",
              "spec/core/kernel/public_send_spec",
              "spec/core/kernel/raise_spec",
              "spec/core/kernel/Rational_spec",
              "spec/core/kernel/singleton_methods_spec",
              "spec/core/kernel/spawn_spec",
              "spec/core/kernel/String_spec",
              "spec/core/kernel/system_spec",
              "spec/core/kernel/__callee___spec",
              "spec/core/kernel/__method___spec",
              "spec/core/main/define_method_spec",
              "spec/core/marshal/dump_spec",
              "spec/core/marshal/load_spec",
              "spec/core/matchdata/eql_spec",
              "spec/core/matchdata/length_spec",
              "spec/core/math/acosh_spec",
              "spec/core/math/atanh_spec",
              "spec/core/method/arity_spec",
              "spec/core/method/call_spec",
              "spec/core/method/eql_spec",
              "spec/core/method/inspect_spec",
              "spec/core/module/alias_method_spec",
              ...
              "spec/core/module/protected_instance_methods_spec",
              "spec/core/module/public_instance_methods_spec",
              "spec/core/numeric/abs_spec",
              "spec/core/numeric/angle_spec",
              "spec/core/numeric/ceil_spec",
              "spec/core/numeric/conjugate_spec",
              "spec/core/numeric/fdiv_spec",
              "spec/core/numeric/imaginary_spec",
              "spec/core/numeric/polar_spec",
              "spec/core/numeric/quo_spec",
              "spec/core/numeric/real_spec",
              "spec/core/numeric/rectangular_spec",
              "spec/core/numeric/step_spec",
              "spec/core/objectspace/define_finalizer_spec",
              "spec/core/proc/call_spec",
              "spec/core/proc/case_compare_spec",
              "spec/core/proc/clone_spec",
              "spec/core/proc/eql_spec",
              "spec/core/proc/inspect_spec",
              "spec/core/proc/lambda_spec",
              "spec/core/proc/source_location_spec",
              "spec/core/random/raw_seed_spec",
              "spec/core/range/begin_spec",
              "spec/core/range/case_compare_spec",
              "spec/core/range/cover_spec",
              "spec/core/range/end_spec",
              "spec/core/range/eql_spec",
              "spec/core/range/include_spec",
              "spec/core/rational/abs_spec",
              "spec/core/rational/ceil_spec",
              "spec/core/rational/coerce_spec",
              "spec/core/rational/comparison_spec",
              "spec/core/rational/denominator_spec",
              "spec/core/rational/divide_spec",
              "spec/core/rational/divmod_spec",
              "spec/core/rational/div_spec",
              "spec/core/rational/equal_value_spec",
              "spec/core/rational/exponent_spec",
              "spec/core/rational/fdiv_spec",
              "spec/core/rational/floor_spec",
              "spec/core/rational/hash_spec",
              "spec/core/rational/inspect_spec",
              "spec/core/rational/minus_spec",
              "spec/core/rational/modulo_spec",
              "spec/core/rational/multiply_spec",
              "spec/core/rational/numerator_spec",
              "spec/core/rational/plus_spec",
              "spec/core/rational/remainder_spec",
              "spec/core/rational/round_spec",
              "spec/core/rational/to_f_spec",
              "spec/core/rational/to_i_spec",
              "spec/core/rational/to_r_spec",
              "spec/core/rational/to_s_spec",
              "spec/core/rational/truncate_spec",
              "spec/core/regexp/compile_spec",
              "spec/core/regexp/eql_spec",
              "spec/core/regexp/escape_spec",
              "spec/core/regexp/new_spec",
              "spec/core/regexp/union_spec",
              "spec/core/string/append_spec",
              "spec/core/string/byteslice_spec",
              "spec/core/string/case_compare_spec",
              "spec/core/string/chars_spec",
              "spec/core/string/codepoints_spec",
              "spec/core/string/concat_spec",
              "spec/core/string/each_char_spec",
              "spec/core/string/each_codepoint_spec",
              "spec/core/string/each_line_spec",
              "spec/core/string/encode_spec",
              "spec/core/string/encoding_spec",
              "spec/core/string/equal_value_spec",
              "spec/core/string/gsub_spec",
              "spec/core/string/initialize_spec",
              "spec/core/string/intern_spec",
              "spec/core/string/length_spec",
              "spec/core/string/lines_spec",
              "spec/core/string/match_spec",
              "spec/core/string/next_spec",
              "spec/core/string/rindex_spec",
              "spec/core/string/to_str_spec",
              "spec/core/string/unpack/at_spec",
              "spec/core/string/unpack/a_spec",
              "spec/core/string/unpack/d_spec",
              "spec/core/string/unpack/i_spec",
              "spec/core/string/unpack/u_spec",
              "spec/core/string/upcase_spec",
              "spec/core/struct/dup_spec",
              "spec/core/struct/each_pair_spec",
              "spec/core/struct/eql_spec",
              "spec/core/struct/inspect_spec",
              "spec/core/symbol/element_reference_spec",
              "spec/core/symbol/id2name_spec",
              "spec/core/symbol/length_spec",
              "spec/core/symbol/next_spec",
              "spec/core/time/asctime_spec",
              "spec/core/time/day_spec",
              "spec/core/time/dst_spec",
              "spec/core/time/getgm_spec",
              "spec/core/time/getlocal_spec",
              "spec/core/time/gmtime_spec",
              "spec/core/time/gmtoff_spec",
              "spec/core/time/gm_spec",
              "spec/core/time/inspect_spec",
              "spec/core/time/local_spec",
              "spec/core/time/mktime_spec",
              "spec/core/time/month_spec",
              "spec/core/time/new_spec",
              "spec/core/time/strftime_spec",
              "spec/core/time/to_i_spec",
              "spec/core/unboundmethod/bind_spec",
              "spec/core/unboundmethod/inspect_spec",
              "spec/core/thread/abort_on_exception_spec",
              "spec/core/thread/backtrace/location/absolute_path_spec",
              "spec/core/thread/exit_spec",
              "spec/core/thread/fork_spec",
              "spec/core/thread/run_spec",
              "spec/core/threadgroup/add_spec",
              "spec/core/fiber/resume_spec",
              "spec/library/bigdecimal/add_spec",
              "spec/library/bigdecimal/case_compare_spec",
              "spec/library/bigdecimal/divide_spec",
              "spec/library/bigdecimal/divmod_spec",
              "spec/library/bigdecimal/exponent_spec",
              "spec/library/bigdecimal/multiply_spec",
              "spec/library/bigdecimal/to_int_spec",
              "spec/library/cgi/htmlextension/a_spec",
              "spec/library/cgi/htmlextension/popup_menu_spec",
              "spec/library/cgi/http_header_spec",
              "spec/library/cgi/queryextension/has_key_spec",
              "spec/library/complex/math/acosh_spec",
              "spec/library/complex/math/acos_spec",
              "spec/library/complex/math/asinh_spec",
              "spec/library/complex/math/asin_spec",
              ...
              "spec/library/complex/math/tan_spec",
              "spec/library/complex/numeric/im_spec",
              "spec/library/continuation/call_spec",
              "spec/library/continuation/kernel/callcc_spec",
              "spec/library/coverage/peek_result_spec",
              "spec/library/coverage/result_spec",
              "spec/library/coverage/start_spec",
              "spec/library/csv/basicwriter/close_on_terminate_spec",
              ...
              "spec/library/csv/writer/initialize_spec",
              "spec/library/csv/writer/terminate_spec",
              "spec/library/date/civil_spec",
              "spec/library/date/commercial_spec",
              "spec/library/date/jd_spec",
              "spec/library/date/new_spec",
              "spec/library/date/ordinal_spec",
              "spec/library/date/parse_spec",
              "spec/library/date/valid_civil_spec",
              "spec/library/date/valid_commercial_spec",
              "spec/library/date/valid_jd_spec",
              "spec/library/date/valid_ordinal_spec",
              "spec/library/datetime/minute_spec",
              "spec/library/datetime/new_spec",
              "spec/library/datetime/second_spec",
              "spec/library/datetime/strftime_spec",
              "spec/library/delegate/delegate_class/instance_methods_spec",
              "spec/library/digest/bubblebabble_spec",
              "spec/library/digest/md5/append_spec",
              "spec/library/digest/md5/length_spec",
              "spec/library/digest/md5/update_spec",
              "spec/library/digest/sha1/digest_spec",
              "spec/library/digest/sha256/append_spec",
              "spec/library/digest/sha256/length_spec",
              "spec/library/digest/sha256/update_spec",
              "spec/library/digest/sha384/append_spec",
              "spec/library/digest/sha384/length_spec",
              "spec/library/digest/sha384/update_spec",
              "spec/library/digest/sha512/append_spec",
              "spec/library/digest/sha512/length_spec",
              "spec/library/digest/sha512/update_spec",
              "spec/library/drb/start_service_spec",
              "spec/library/drb/stop_service_spec",
              "spec/library/erb/util/html_escape_spec",
              "spec/library/erb/util/url_encode_spec",
              "spec/library/etc/endgrent_spec",
              "spec/library/etc/endpwent_spec",
              "spec/library/etc/getgrent_spec",
              "spec/library/etc/getgrgid_spec",
              ...
              "spec/library/net/http/http/put2_spec",
              "spec/library/net/http/http/started_spec",
              "spec/library/net/http/httpexceptions/initialize_spec",
              "spec/library/net/http/httpheader/add_field_spec",
              "spec/library/net/http/httpheader/canonical_each_spec",
              "spec/library/net/http/httpheader/content_type_spec",
              "spec/library/net/http/httpheader/each_header_spec",
              "spec/library/net/http/httpheader/each_key_spec",
              "spec/library/net/http/httpheader/form_data_spec",
              "spec/library/net/http/httpheader/length_spec",
              "spec/library/net/http/httpheader/range_spec",
              "spec/library/net/http/httpresponse/body_spec",
              "spec/library/observer/add_observer_spec",
              "spec/library/open3/capture2e_spec",
              "spec/library/open3/capture2_spec",
              "spec/library/open3/capture3_spec",
              ...
              "spec/library/open3/popen2_spec",
              "spec/library/open3/popen3_spec",
              "spec/library/openssl/cipher_spec",
              "spec/library/openssl/random/pseudo_bytes_spec",
              "spec/library/openstruct/equal_value_spec",
              "spec/library/openstruct/inspect_spec",
              "spec/library/pathname/absolute_spec",
              "spec/library/pathname/equal_value_spec",
              "spec/library/pathname/hash_spec",
              "spec/library/pathname/join_spec",
              ...
              "spec/library/securerandom/random_bytes_spec",
              "spec/library/securerandom/random_number_spec",
              "spec/library/set/add_spec",
              "spec/library/set/collect_spec",
              "spec/library/set/difference_spec",
              "spec/library/set/include_spec",
              "spec/library/set/intersection_spec",
              "spec/library/set/length_spec",
              "spec/library/set/plus_spec",
              "spec/library/set/sortedset/add_spec",
              "spec/library/set/sortedset/collect_spec",
              "spec/library/set/sortedset/difference_spec",
              "spec/library/set/sortedset/include_spec",
              "spec/library/set/sortedset/intersection_spec",
              "spec/library/set/sortedset/length_spec",
              "spec/library/set/sortedset/plus_spec",
              "spec/library/shellwords/shellwords_spec",
              "spec/library/singleton/allocate_spec",
              "spec/library/socket/addrinfo/bind_spec",
              "spec/library/socket/addrinfo/to_sockaddr_spec",
              "spec/library/socket/basicsocket/recv_nonblock_spec",
              "spec/library/socket/socket/pack_sockaddr_in_spec",
              ...
              "spec/library/stringio/read_nonblock_spec",
              "spec/library/stringio/syswrite_spec",
              "spec/library/stringscanner/append_spec",
              "spec/library/stringscanner/beginning_of_line_spec",
              "spec/library/stringscanner/clear_spec",
              "spec/library/stringscanner/empty_spec",
              "spec/library/stringscanner/getbyte_spec",
              "spec/library/stringscanner/getch_spec",
              "spec/library/stringscanner/matched_size_spec",
              "spec/library/stringscanner/matched_spec",
              "spec/library/stringscanner/peek_spec",
              "spec/library/stringscanner/pointer_spec",
              "spec/library/stringscanner/restsize_spec",
              "spec/library/tempfile/delete_spec",
              "spec/library/tempfile/length_spec",
              "spec/library/thread/queue/append_spec",
              "spec/library/thread/queue/clear_spec",
              "spec/library/thread/queue/closed_spec",
              "spec/library/thread/queue/close_spec",
              "spec/library/thread/queue/deq_spec",
              "spec/library/thread/queue/empty_spec",
              "spec/library/thread/queue/length_spec",
              "spec/library/thread/queue/num_waiting_spec",
              "spec/library/thread/sizedqueue/append_spec",
              "spec/library/time/iso8601_spec",
              "spec/library/time/rfc2822_spec",
              "spec/library/uri/eql_spec",
              "spec/library/uri/equality_spec",
              "spec/library/uri/parser/extract_spec",
              "spec/library/uri/parser/join_spec",
              "spec/library/uri/parser/parse_spec",
              "spec/library/weakref/send_spec",
              "spec/library/weakref/weakref_alive_spec",
              "spec/library/win32ole/win32ole/codepage_spec",
              "spec/library/win32ole/win32ole/connect_spec",
              "spec/library/win32ole/win32ole/constants_spec",
              "spec/library/win32ole/win32ole/const_load_spec",
              "spec/library/win32ole/win32ole/create_guid_spec",
              "spec/library/win32ole/win32ole/invoke_spec",
              "spec/library/win32ole/win32ole/locale_spec",
              "spec/library/win32ole/win32ole/new_spec",
              "spec/library/win32ole/win32ole/ole_func_methods_spec",
              "spec/library/win32ole/win32ole/ole_methods_spec",
              "spec/library/win32ole/win32ole/ole_method_help_spec",
              "spec/library/win32ole/win32ole/ole_method_spec",
              "spec/library/win32ole/win32ole/ole_obj_help_spec",
              "spec/library/win32ole/win32ole/ole_put_methods_spec",
              "spec/library/win32ole/win32ole/setproperty_spec",
              "spec/library/win32ole/win32ole/_getproperty_spec",
              "spec/library/win32ole/win32ole/_invoke_spec",
              "spec/library/win32ole/win32ole_event/new_spec",
              "spec/library/win32ole/win32ole_event/on_event_spec",
              "spec/library/win32ole/win32ole_method/dispid_spec",
              "spec/library/win32ole/win32ole_method/event_interface_spec",
              "spec/library/win32ole/win32ole_method/event_spec",
              "spec/library/win32ole/win32ole_method/helpcontext_spec",
              "spec/library/win32ole/win32ole_method/helpfile_spec",
              "spec/library/win32ole/win32ole_method/helpstring_spec",
              "spec/library/win32ole/win32ole_method/invkind_spec",
              "spec/library/win32ole/win32ole_method/invoke_kind_spec",
              "spec/library/win32ole/win32ole_method/name_spec",
              "spec/library/win32ole/win32ole_method/new_spec",
              "spec/library/win32ole/win32ole_method/offset_vtbl_spec",
              "spec/library/win32ole/win32ole_method/params_spec",
              "spec/library/win32ole/win32ole_method/return_type_detail_spec",
              "spec/library/win32ole/win32ole_method/return_type_spec",
              "spec/library/win32ole/win32ole_method/return_vtype_spec",
              "spec/library/win32ole/win32ole_method/size_opt_params_spec",
              "spec/library/win32ole/win32ole_method/size_params_spec",
              "spec/library/win32ole/win32ole_method/to_s_spec",
              "spec/library/win32ole/win32ole_method/visible_spec",
              "spec/library/win32ole/win32ole_param/default_spec",
              "spec/library/win32ole/win32ole_param/input_spec",
              "spec/library/win32ole/win32ole_param/name_spec",
              "spec/library/win32ole/win32ole_param/ole_type_detail_spec",
              "spec/library/win32ole/win32ole_param/ole_type_spec",
              "spec/library/win32ole/win32ole_param/optional_spec",
              "spec/library/win32ole/win32ole_param/retval_spec",
              "spec/library/win32ole/win32ole_param/to_s_spec",
              "spec/library/win32ole/win32ole_type/guid_spec",
              "spec/library/win32ole/win32ole_type/helpcontext_spec",
              "spec/library/win32ole/win32ole_type/helpfile_spec",
              "spec/library/win32ole/win32ole_type/helpstring_spec",
              "spec/library/win32ole/win32ole_type/major_version_spec",
              "spec/library/win32ole/win32ole_type/minor_version_spec",
              "spec/library/win32ole/win32ole_type/name_spec",
              "spec/library/win32ole/win32ole_type/new_spec",
              "spec/library/win32ole/win32ole_type/ole_classes_spec",
              "spec/library/win32ole/win32ole_type/ole_methods_spec",
              "spec/library/win32ole/win32ole_type/ole_type_spec",
              "spec/library/win32ole/win32ole_type/progids_spec",
              "spec/library/win32ole/win32ole_type/progid_spec",
              "spec/library/win32ole/win32ole_type/src_type_spec",
              "spec/library/win32ole/win32ole_type/to_s_spec",
              "spec/library/win32ole/win32ole_type/typekind_spec",
              "spec/library/win32ole/win32ole_type/typelibs_spec",
              "spec/library/win32ole/win32ole_type/variables_spec",
              "spec/library/win32ole/win32ole_type/visible_spec",
              "spec/library/win32ole/win32ole_variable/name_spec",
              "spec/library/win32ole/win32ole_variable/ole_type_detail_spec",
              "spec/library/win32ole/win32ole_variable/ole_type_spec",
              "spec/library/win32ole/win32ole_variable/to_s_spec",
              "spec/library/win32ole/win32ole_variable/value_spec",
              "spec/library/win32ole/win32ole_variable/variable_kind_spec",
              "spec/library/win32ole/win32ole_variable/varkind_spec",
              "spec/library/win32ole/win32ole_variable/visible_spec",
              "spec/library/yaml/add_builtin_type_spec",
              "spec/library/yaml/load_documents_spec",
              "spec/library/yaml/to_yaml_spec",
              "spec/library/zlib/gzipreader/each_line_spec",
              ...
              "spec/core/dir/unlink_spec",
              "spec/core/encoding/to_s_spec",
              "spec/core/enumerable/zip_spec",
              "spec/core/exception/load_error_spec",
              "spec/core/file/absolute_path_spec",
              "spec/core/file/exist_spec",
              "spec/core/file/realdirpath_spec",
              "spec/core/filetest/directory_spec",
              "spec/core/hash/store_spec",
              "spec/core/hash/to_s_spec",
              "spec/core/integer/chr_spec",
              "spec/core/io/each_codepoint_spec",
              ...
              "spec/library/weakref/__getobj___spec",
              "spec/library/yaml/add_domain_type_spec",
              "spec/library/zlib/gzipreader/read_spec",
              ...
              "spec/core/kernel/trace_var_spec",
              "spec/core/encoding/converter/finish_spec",
              "spec/core/encoding/converter/inspect_spec",
              "spec/core/kernel/__dir___spec",
              "spec/core/encoding/converter/last_error_spec",
              "spec/core/main/include_spec",
              "spec/core/encoding/converter/new_spec",
              "spec/core/encoding/converter/primitive_convert_spec",
              "spec/core/encoding/converter/primitive_errinfo_spec",
              "spec/core/encoding/converter/putback_spec",
              "spec/core/encoding/converter/replacement_spec",
              ...
              "spec/core/encoding/list_spec",
              "spec/core/encoding/names_spec",
              "spec/core/encoding/undefined_conversion_error/destination_encoding_name_spec",
              "spec/core/encoding/undefined_conversion_error/destination_encoding_spec",
              "spec/core/encoding/undefined_conversion_error/error_char_spec",
              "spec/core/encoding/undefined_conversion_error/source_encoding_name_spec",
              "spec/core/encoding/undefined_conversion_error/source_encoding_spec",
              "spec/core/encoding/invalid_byte_sequence_error/destination_encoding_spec"
