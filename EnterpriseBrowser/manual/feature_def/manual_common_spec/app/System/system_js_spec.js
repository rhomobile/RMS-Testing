...
describe("System Module JS Test Starts Here", function() {
	...
	describe("System Module-Setting Directly Test Starts Here", function() {
		it("VT300-027 | call getProperty with locale | ", function() {
			runs(function(){
				var data = EB.System.getProperty('locale');
		...
		it("VT300-028 | call getProperty with ScreenAutoRotate | ", function() {
			runs(function(){
				var data = EB.System.getProperty('screenAutoRotate');
	      		displayResult("VT300-027 | call getProperty with screenAutoRotate | ",data);
			});
		...
		it("VT300-070 | call getAllProperties() | ", function() {
			runs(function(){
				var data =  EB.System.getAllProperties();
			...
			(function(idx){
				if(isTestApplicable(sys_get_property[idx]['osType'])){
					it(sys_get_property[idx]['testName'], function() {
						runs(function(){
							var data = EB.System.getProperty(sys_get_property[idx]['propertyName']);
	...
	describe("System Module- getProperties Test Starts Here", function() {
		...
		it("VT300-126 | call getproperties with country,deviceName, devicePushId, freeServerPort and sync callback | ", function() {
			runs(function(){
				var data = EB.System.getProperties(['country','deviceName','devicePushId','freeServerPort']);
				...
				if(isTestApplicable(sys_get_properties[idx]['osType'])){
					it(sys_get_properties[idx]['testName'], function() {
						runs(function(){
							...
							var data = EB.System.getProperties(objGetProperty);
		...
		it("VT300-127  | call getproperties with callback as anonymous function | ", function() {
			...
			runs(function(){
				...
				EB.System.getProperties(['country','deviceName','devicePushId','freeServerPort'],function(objData){
		...
		it("VT300-128 | call getproperties with callback as async defined function | ", function() {
			...
			runs(function(){
				...
				EB.System.getProperties(['country','deviceName','devicePushId','freeServerPort'],sysAsyncCallback);
