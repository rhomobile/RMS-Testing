...
// setup 
    it('initialize before tests', function() {
        ...
        }, '70sec waiting for Search printer', 70000);
    ...
    describe('printImageFromFile method', function() {
        ...
        generatePrintImageWithoutAnonymous('Anonymous', pngimagepath_640px, 10, 10, {
            'width': 50,
            'height': 50,
            'isInsideFormat': false
        }, true);
        generatePrintImageWithoutAnonymous('Anonymous', pngimagepath_1024px, 10, 10, {
            'width': -1,
            'height': -1,
            'isInsideFormat': false
        }, true);
        ...
        generatePrintImageWithoutAnonymous('Anonymous', jpgimagepath_640px, 10, 10, {
            'width': 50,
            'height': 50,
            'isInsideFormat': true
        }, true);
    ...
    describe("Should print a raw string after setting default printer", function() {
        it("Should print a raw string after setting default printer ", function() {
            ...
            runs(function() {
                ...
                expect(EB.PrinterZebra.getDefault().getId()).toEqual(printerObj.getId());
            });

            runs(function() {
                EB.PrinterZebra.connect(function(res){ console.log(res); callresult = res; });
            });
            ...
            runs(function() {
                EB.PrinterZebra.printRawString(CommandCCPL, {});
            });
