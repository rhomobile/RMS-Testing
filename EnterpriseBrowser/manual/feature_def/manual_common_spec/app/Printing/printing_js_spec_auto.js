...
describe('Printing Generic', function() {
    ...
    //var allEnumPrinters = [EB.Printer.PRINTER_TYPE_ANY, EB.Printer.PRINTER_TYPE_NATIVE, EB.Printer.PRINTER_TYPE_ZEBRA, EB.Printer.PRINTER_TYPE_EPSON, EB.Printer.PRINTER_TYPE_APD]
    var allEnumPrinters = [EB.Printer.PRINTER_TYPE_ZEBRA]
    var printers_array = [];
    var printers_errors = [];
    ...
    function makeFilePath(filename) {
        return EB.RhoFile.join(EB.Application.modelFolderPath('Printer'), EB.RhoFile.join('PrinterFiles', filename));
    }
...
/*  function displayTestDescription(aString) {
    ...
    describe('enumerateSupportedTypes method', function() {
        it('using result', function() {
            runs(function() {
                var printerTypes = EB.Printer.enumerateSupportedTypes();
                //alert(printerTypes);
        ...
        it('using callback', function() {
            ...
            runs(function() {
                EB.Printer.enumerateSupportedTypes(enumerateCallback);
            });
            waitsFor(function() {
                return enumCb !== null;
        ...
        it('using anonymous callback', function() {
            ...
            runs(function() {
                EB.Printer.enumerateSupportedTypes(
        ...
        function generateSearchTest(description, searchParamaters, shouldFail) {
            it(description, function() {
                ...
                runs(function() {
                    ...
                    EB.Printer.searchPrinters(searchVals, searchPrinterCallback);
                });
                ...
                runs(function() {
                    ...
                    if (searchParamaters['timeout'] && !searchParamaters['deviceAddress'] && $('#dev_conn_type').val()!=EB.Printer.CONNECTION_TYPE_BLUETOOTH) {
    ...
    describe('should getPrinterByID', function() {
        ...
        it('and get base properties', function() {
            ...
            runs(function() {
                ...
                var thisprinter = EB.Printer.getPrinterByID(last_found_printer_id);
                //thisprinter.connect();
    ...
    describe('connect and disconnect methods', function() {
        ...
        it('disconnect and try to print should return status error', function() {
            ...
            runs(function() {
                expect(callresult.status).toEqual(EB.Printer.PRINTER_STATUS_ERR_NOT_CONNECTED);
            });
        });
    ...
    describe('enumerateSupportedControlLanguages method', function() {
        //var controlLangs = [EB.Printer.PRINTER_LANGUAGE_ZPL, EB.Printer.PRINTER_LANGUAGE_CPCL, EB.Printer.PRINTER_LANGUAGE_EPS]
        var controlLangs = [EB.Printer.PRINTER_LANGUAGE_ZPL, EB.Printer.PRINTER_LANGUAGE_CPCL]
        ...
        describe('stopSearch method', function() {
            it("callback should not fire after calling stopSearch", function () {
                runs(function () {
                    ...
                    callresult = EB.Printer.stopSearch();
                });
    ...
    var listofrequeststate = [EB.Printer.PRINTER_STATE_IS_READY_TO_PRINT,    EB.Printer.PRINTER_STATE_IS_COVER_OPENED, EB.Printer.PRINTER_STATE_IS_DRAWER_OPENED, EB.Printer.PRINTER_STATE_IS_PAPER_OUT, EB.Printer.PRINTER_STATE_IS_BATTERY_LOW];
    ...
    function requestStateCallback(args) {
        if (args.status == EB.Printer.PRINTER_STATUS_SUCCESS) {
            expect(args.status).toEqual(EB.Printer.PRINTER_STATUS_SUCCESS);   
    ...
    describe('requestState method', function() {
        ...
        it("Request printer state for list of parameters", function() {
            ...
            runs(function() {
                expect(requeststate_callbackValue.status).toEqual(EB.Printer.PRINTER_STATUS_SUCCESS);
            });
        }); 
    ...
    describe("Get & Set default printer", function() {
        ...
        it('set default Printer', function() {
            runs(function() {
                EB.Printer.setDefault(printerObj);
                var defPrinter = EB.Printer.getDefault();
