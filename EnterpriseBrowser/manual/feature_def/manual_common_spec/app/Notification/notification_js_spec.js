...
describe("Notification Manual FD Tests", function () {
    ...
    var buttonCallback = function (args) {
        ...
        EB.Log.info(args.button_id, 'button_id');
        EB.Log.info(args.button_title, 'button_title');
        EB.Log.info(args.button_index, 'button_index');
    }
    ...
    it("VT281-0854 |showPopup with Message and title , icon and buttons  as well |", function () {
        ...
        runs(function () {
            ...
            var propertyMap = {message: 'This is a pop up with buttons', buttons: [
                ...
                'No',
                'Cancel'
            ], title: 'MyTitle', icon: EB.RhoFile.join(EB.Application.modelFolderPath('Notification'), 'icon.png')};
            EB.Notification.showPopup(propertyMap);
        });
    ...
    if (EB.System.platform == "ANDROID") {
        describe("JS EB.Notification For Android Changes", function () {
            ...
            it("should check the behavior of toast when message length is too large",function(){
                ...
                dispTestCaseRunning(" Call EB.Notification.showStatus with title - Test status_text - A very long string hide_button_label - Confirm");
                ...
                runs(function(){
                    EB.Application.minimize();
                    setTimeout(function() {
                        EB.Notification.showStatus("Test", "Welcome to the Rhomobile Suite documentation site. Here you will find developer guides to walk you through activities using the framework. You will also find a complete API reference section that describes the available interfaces.", "Confirm");
                    }, 3000);
                });
            ...
            it("should check the behavior of toast when status_text is empty in showStatus",function(){
                ...
                dispTestCaseRunning("Call EB.Notification.showStatus with \n title - Test status_text -  '' \n hide_button_label - Confirm");
                ...
                runs(function(){
                    EB.Application.minimize();
                    setTimeout(function() {
                        EB.Notification.showStatus("Test", "", "Confirm");
                    }, 3000);
                });
            ...
            it("should display a popup when types is only EB.Notification.TYPE_DIALOG",function(){

                dispTestCaseRunning('Call EB.Notification.showPopup({title:"Displaying a pop up",\n message:"Test message",\n icon: "info",\n <b>types: [EB.TYPE_DIALOG]</b>}, function(params) {});');
                ...
                runs(function(){
                    EB.Notification.showPopup({
                            ...
                            icon: "info",
                            buttons: [{id: 'ok', title: 'ok'}],
                            types: [EB.Notification.TYPE_DIALOG]},
                        function(params) {}
                    );
                });
            ...
            it("should display a popup when types is only EB.Notification.TYPE_DIALOG when application is in background",function(){
            ...
            it("should display user defined icon in notification bar with message ",function(){
                ...
                runs(function(){
					alert(EB.RhoFile.exists("/mnt/sdcard/images/dummy.png"));
                    EB.Application.minimize();
                    setTimeout(function() {
                        EB.Notification.showPopup({
                                message:"Test Message",
                               ...
                               //icon: EB.RhoFile.join(EB.Application.modelFolderPath('Notification'), 'icon.png')}
							      //icon: "/mnt/sdcard/images/dummy.png"}
								  icon:EB.RhoFile.join('/sdcard','icon.png')}
                        );
                    }, 3000);
                });
                ...
                runs(function(){
                    ...
                    setTimeout(function() {
                        EB.Notification.showPopup({
                            ...
                            function(params) {
                                EB.Notification.showStatus("Test", JSON.stringify(params), "Confirm");
                            }
                        );
                    }, 3000);
                });
            ...
            it("should display a info icon in notification bar with buttons",function(){
                ...
                dispTestCaseRunning('Call EB.Notification.showPopup({title:"showPopup without dialog",\n message:"Test Message",\n icon: "info",\n <b>types: ["notificationDialog"]</b>}, function(params) {});');
                dispExpectedResult(jasmine.getEnv().currentSpec.description);
            ...
            it("should display a toast when types is only toast and application is in background",function(){
                ...
                dispTestCaseRunning('Call EB.Notification.showPopup({message:"Test Message",<b>types: ["toast"]</b>}); when application is in background');
                dispExpectedResult("It should display a toast message whether application is in background or foreground.");
            ...
            it("should display all applicable type of notification when types mentioned with dialog, notification, notificationDialog, toast and when app is in foreground.",function(){
                ...
                runs(function(){
                    EB.Notification.showPopup({
                            ...
                            types: [EB.Notification.TYPE_DIALOG, EB.Notification.TYPE_NOTIFICATION, EB.Notification.TYPE_NOTIFICATION_DIALOG, EB.Notification.TYPE_TOAST]},
                        function (params) {
                        }
                    );
                });
                ...
                runs(function(){
                    ...
                    setTimeout(function() {
                        EB.Notification.showPopup({
                                ...
                                message:"Test Message",
                                buttons: [{id: 'accept', title: 'ok'}],
                                types: [EB.Notification.TYPE_DIALOG, EB.Notification.TYPE_NOTIFICATION_DIALOG, EB.Notification.TYPE_TOAST]},
                            function(params) {}
                        );
                    }, 3000);
            ...
            it("should display only dialog",function(){
                ...
                runs(function(){
                    EB.Notification.showPopup({
                            ...
                            icon: "info",
                            buttons: [{id: 'ok', title: 'ok'}],
                            types: [EB.Notification.TYPE_NOTIFICATION_DIALOG, EB.Notification.TYPE_TOAST]},
                        function(params) {}
                    );
                });
        ...
        describe("RUBY EB.Notification For Android Changes", function () {
            ...
            it("Should allow to interact with application from notification area without activating the application when types is only EB.Notification.TYPE_NOTIFICATION_DIALOG.",function(){

                dispTestCaseRunning('Call EB.Notification.showPopup({title:"Displaying a pop up",\n message:"Test Message",\n icon: "info",\n <b>types: [EB.Notification.TYPE_NOTIFICATION_DIALOG]</b>}, function(params) {});');
            ...
            it("should display a toast when type is only EB.Notification.TYPE_TOAST",function(){
    ...
    if (EB.System.platform == "WINDOWS_DESKTOP" || EB.System.isRhoSimulator) {
    } else
    {
        if (EB.System.platform == "WINDOWS" || EB.System.platform == "ANDROID")
        {
            it("VT307-001 |Beep for 5 secs and with volume 3 with 1000 hz|", function () {
                ...
                runs(function () {
                    ...
                    EB.Notification.beep(propertyMap);
        ...
        it("VT307-008|Play File - Mp3 file with media type|", function () {
            ...
            runs(function () {
				...
				EB.Notification.playFile(EB.RhoFile.join('/sdcard/Application/', 'super_android_tune.mp3'), '.mp3');
				}
            });
        ...
        it("VT307-009|Play File - Mp3 file without media type|", function () {
            ...
            runs(function () {
                ...
                dispExpectedResult("MP3 file should be played ");
				if(isWindowsMobilePlatform()){
                EB.Notification.playFile(EB.RhoFile.join(EB.Application.modelFolderPath('Notification'), 'media1.mp3'));
				}
				if(isAndroidPlatform() || isApplePlatform()){
				EB.Notification.playFile(EB.RhoFile.join('/sdcard/Application/', 'super_android_tune.mp3'));
				}
            });
        ...
        it("VT307-010|Play File - Wav file with media type|", function () {
            ...
            runs(function () {
				...
				if(isWindowsMobilePlatform()){
                EB.Notification.playFile(EB.RhoFile.join(EB.Application.modelFolderPath('Notification'), 'media2.wav'), '.wav');
				}
				if(isAndroidPlatform() || isApplePlatform()){
				
				EB.Notification.playFile(EB.RhoFile.join('/sdcard/Application/', 'badfeeling.wav'), '.wav');
				}
