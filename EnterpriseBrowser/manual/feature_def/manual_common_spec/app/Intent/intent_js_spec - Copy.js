...
describe('Intent_UseCases Functionality Test', function () {
    ...
    if(isAndroidPlatform()){
        ...
        it('VT328_05 | intentType - Start service of the test appliation.', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_SERVICE,"appName":"com.rhomobile.manual_common_spec","targetClass":"com.rhomobile.rhodes.RhodesService", "data":{"message":"Mesage to service"}}');
