...
describe('Intent_UseCases Functionality Test', function () {
    ...
    if(isAndroidPlatform()){
        ...
        it('VT328_03 | intentType - StartActivity: Launch target application by \'className\',which is installed but not running.', function () {
            ...
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"params":{"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","appName":"com.smap.targetapp","targetClass":"com.smap.targetapp.MainActivity"}}');
            dispExpectedResult('The Target application should be launched successfully.');
            _result.waitToRunTest();
            runs(function () {
                var params = new parameters(EB.Intent.START_ACTIVITY,"","ACTION_MAIN","","com.smap.targetapp","com.smap.targetapp.MainActivity","","","");
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
        ...
        it('VT328_05 | intentType - Start service of the test appliation.', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_SERVICE,"appName":"com.motorolasolutions.enterprisebrowser","targetClass":"com.rhomobile.rhodes.RhodesService", "data":{"message":"Mesage to service"}}');
            dispExpectedResult('Service of test application should be started and toast from service is shown.');
            _result.waitToRunTest();
            runs(function () {
                var mytestapp = 'com.motorolasolutions.enterprisebrowser';
                var params = new parameters(EB.Intent.START_SERVICE,"","","",mytestapp,"com.rhomobile.rhodes.RhodesService","","",{"message":"Message to service"});
        ...
        it('VT328_08 | intentType - Start service of the target applciation in which the service is already instantiated', function () {
            ...
            var preConditions = ["Ensure Target application installed in the device"];
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent two times with parameters {"intentType":EB.Intent.START_SERVICE, "appName":"com.smap.targetapp", "targetClass":"com.smap.targetapp.MyFirstService"}');
            ...
            _result.waitToRunTest();
            runs(function () {
                var params = new parameters(EB.Intent.START_SERVICE,"","ACTION_MAIN","","com.smap.targetapp","com.smap.targetapp.MyFirstService","","","");
                EB.Intent.send(params);
                EB.Intent.send(params);
            });
            _result.waitForResponse();
		...
		it('VT328_10 | intentType - Broadcast data from test app and receive at target app with permission', function () {
            ...
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.BROADCAST, "permission":"com.example.testtarget.PERMISSION","action":"com.smap.targetapp.mySecondAction", "data":{"toast":"Target -Test case passed If you see this in Andorid Toast !"}}');
            ...
            runs(function () {
                ...
                var params = new parameters(EB.Intent.BROADCAST,"com.example.testtarget.PERMISSION","com.smap.targetapp.mySecondAction","","","","","",data);
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
        it('VT328_11 | intentType - Broadcast data from test app and receive back at test app.', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.BROADCAST, "action":"com.smap.targetapp.mySecondAction", "data":{"reply":"This is my broadcast data!"}}');
            ...
            runs(function () {
                ...
                EB.Intent.startListening(listeningCB);
                
                var params = new parameters(EB.Intent.BROADCAST,"","com.smap.targetapp.mySecondAction","","","","","",{"reply":"This is my broadcast data!"});
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
        it('VT328_12 | intentType - Broadcast data from test app and receive at target app, when target app is not running.', function () {
            ...
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.BROADCAST, "appName":"com.smap.targetapp", "data":{"toast":"Target: Test case passed If you see this in Andorid Toast !"}}');
            dispExpectedResult('Broadcast should be successful.');
            _result.waitToRunTest();
            runs(function () {
                var params = new parameters(EB.Intent.BROADCAST,"","","","com.smap.targetapp","","","",{"toast":"Target - Test case passed If you see this in Andorid Toast !"});
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
        ...
        it('VT328_14 | category - Launch Music Player from test application by setting category "CATEGORY_APP_MUSIC"  and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_MUSIC"]}');
        ...
        it('VT328_15 | category - Launch Calculator from test applciation by setting category "CATEGORY_APP_CALCULATOR"  and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_CALCULATOR"]}');
        ...
        it('VT328_16 | category - Launch Calendar from test application by setting category "CATEGORY_APP_CALENDAR" and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_CALENDAR"]}');
        ...
        it('VT328_17 | category - Launch contacts from test application by setting category "CATEGORY_APP_CONTACTS" and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_CONTACTS"]}');
        ...
        it('VT328_18 | category - Launch Email application from test application by setting category "CATEGORY_APP_EMAIL" and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_EMAIL"]}');
        ...
        it('VT328_19 | category - Launch Gallery application from test app by setting category "CATEGORY_APP_GALLERY" and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_GALLERY"]}');
        ...
        xit('VT328_20 | category - Launch Maps application from test app by setting category "CATEGORY_APP_MAPS" and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_MAPS"]}');
        ...
        it('VT328_21 | category - Launch Message application from test app by setting category "CATEGORY_APP_MESSAGING" and action "ACTION_MAIN"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_MAIN","categories":["CATEGORY_APP_MESSAGING"]}');
        ...
        it('VT328_23 | mimeType - Launch Message application from test app by setting mimeType "vnd.android-dir/mms-sms" and Data to "This is message body !"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"params":{"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_SEND","categories":"","appName":"","targetClass":"","uri":"","mimeType":"vnd.android-dir/mms-sms",{"EXTRA_TEXT":"This should be in message body!"}}}');
            dispExpectedResult('Messaging app launched successfully and message body should contain "This is message body !"');
            _result.waitToRunTest();
            runs(function () {
                var data = {"sms_body":"This is message body !"};
                var params = new parameters(EB.Intent.START_ACTIVITY,"","ACTION_VIEW","","","","","vnd.android-dir/mms-sms",data);
                EB.Intent.send(params);
            });
            _result.waitForResponse();
		...
		xit('VT328_24 | mimeType - Launch Image viewer from test app by setting an EXTRA - EXTRA_STREAM with "image data URI"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"params":{"intentType":EB.Intent.START_ACTIVITY,"action":"","categories":"","appName":"","targetClass":"","uri":"","mimeType":"image/jpeg",{"EXTRA_STREAM":"data:image/jpeg;base64,/qerwe.... "}}');
            ...
            runs(function () {
                ...
                var params = new parameters(EB.Intent.START_ACTIVITY,"","","","","","","image/jpeg",data);
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
    ...
    if(isApplePlatform()){
        ...
        xit('VT328_25 | mimeType - Launch Image viewer from test app by setting uri to "image data URI"', function () {
            displayObjective('VT328_24 | mimeType - Launch Image viewer from test app by setting mimeType "image (jpeg, gif, png etc.,)" and Data to "image data URI"');
            dispTestCaseRunning('Sending Intent with parameters {"params":{"intentType":EB.Intent.START_ACTIVITY,"action":"","categories":"","appName":"","targetClass":"","uri":"","mimeType":"image/jpeg","data":"<data:image/jpeg;base64,/qerwe.... >"}}');
            dispExpectedResult('Image viewer should be launched successfully.');
            _result.waitToRunTest();
            runs(function () {
                ...
                var params = new parameters(EB.Intent.START_ACTIVITY,"","","","","",uri,"image/jpeg","");
                EB.Intent.send(params);
    ...
    it('VT328_30 | uri - Launch Message application with data from test app by setting URI "sms:9611896991"', function () {
        ...
        dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"uri":"sms:9611896991"}');
    ...
    it('VT328_31 | uri - Launch Email appliation with data from test app by setting URI "mailto:abcd@domain.com"', function () {
        ...
        displayPrecondition(preConditions);
        dispTestCaseRunning('Sending Intent with parameters Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"uri":"mailto:abcd@domain.com"}');
        dispExpectedResult('Email compose view should be launched with pre-filled recepient email address.');
        _result.waitToRunTest();
        runs(function () {
             var params;
             if (isAndroidPlatform()) {
                params = new parameters(EB.Intent.START_ACTIVITY,"","","","","","mailto:abcd@domain.com","","");
             } else {
    ...
    if (!isApplePlatform()) {
         it('VT328_30 | uri - Launch Message application with data from test app by setting URI "sms:9611896991"', function () {
            ...
            runs(function () {
            	var params;
            	if (isAndroidPlatform()) {
            		params = new parameters(EB.Intent.START_ACTIVITY,"","","","","","sms:9611896991","","");
                }
                if (isAnyWindowsFamilyPlatform()) {
                	params = new parameters(EB.Intent.START_ACTIVITY,"","","","","","sms:9611896991","","");
                }
         ...
         it('VT328_33 | uri - Launch Maps with pre-set lat and longitute values from test app by setting Uri "geo:latitude,longitude"', function () {
            ...
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_VIEW","uri":"geo:12.9667° N, 77.5667° E"}');
            dispExpectedResult('Maps application launched with the pre-set Lattitude and Longitude');
            _result.waitToRunTest();
            runs(function () {
                 var params = new parameters(EB.Intent.START_ACTIVITY,"","ACTION_VIEW","","","","geo:12.9667° N, 77.5667° E","","");
                 EB.Intent.send(params);
                 });
            _result.waitForResponse();
            });
         ...
         it('VT328_34 | uri - Make a call from test application by setting URI "tel:9611896991" and Action : "ACTION_CALL"', function () {
            ...
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_CALL","uri":"tel:9611896991"}');
            dispExpectedResult('Phone call made to the pre-loaded number.');
            _result.waitToRunTest();
            runs(function () {
                 var params = new parameters(EB.Intent.START_ACTIVITY,"","ACTION_CALL","","","","tel:9611896991","","");
                 EB.Intent.send(params);
                 });
            _result.waitForResponse();
            });
    ...
    if(isAndroidPlatform()){
        it('VT328_35 | uri - Launch Contacts from test application via Uri "content://contacts/people/" and Action: ACTION_VIEW', function () {
            ...
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_VIEW",,"uri":"content://contacts/people/"}');
            dispExpectedResult('Contacts application is launched successfully');
            _result.waitToRunTest();
            runs(function () {
                var params = new parameters(EB.Intent.START_ACTIVITY,"","ACTION_VIEW","","","","content://contacts/people/","","");
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
        it('VT328_36 | uri - Launch individual contact from test application via Uri "content://contacts/people/1" and Action: ACTION_VIEW', function () {
            displayObjective('VT328_35 | uri - Launch Contacts from test application via Uri "content://contacts/people/1" and Action: ACTION_VIEW');
            var preConditions = ["Ensure atleast one contact is present in the device"];
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"action":"ACTION_EDIT","uri":"content://contacts/people/1"}');
            dispExpectedResult('Contacts application is launched and details of first contact displayed successfully');
            _result.waitToRunTest();
            runs(function () {
                var params = new parameters(EB.Intent.START_ACTIVITY,"","ACTION_EDIT","","","","content://contacts/people/1","","");
                EB.Intent.send(params);
            });
            _result.waitForResponse();
        });
    ...
    if(!isApplePlatform()) {
         it('VT328_37 | uri - Launch Email compose screen with pre-filled email from test application by setting URI and data.', function () {
            ...
            displayPrecondition(preConditions);
            dispTestCaseRunning('Sending Intent with parameters {"intentType":EB.Intent.START_ACTIVITY,"uri":"mailto:abcd@domain.com","data":{"body":"This is test email body"}}');
            ...
            runs(function () {
                 ...
                 var params = new parameters(EB.Intent.START_ACTIVITY,"","","","","","mailto:abcd@domain.com","",data);
                 EB.Intent.send(params);
                 });
            _result.waitForResponse();
            });
    ...
    it('VT328_39 | Start Listening to the background intents - broadcast messages (receiving broadcast messages)', function () {
        ...
        runs(function () {
            ...
            if (isAnyWindowsFamilyPlatform()) {
                params = new parameters(EB.Intent.BROADCAST,"","","","Symbol EnterpriseBrowser/Menu.exe","","","",data);
            }
    ...
    it('VT328_45 | Sending Intent with null in place of callback function', function(){
        ...
        if (isAndroidPlatform()) {
            parameters = {intentType: EB.Intent.START_ACTIVITY, appName:  "com.smap.targetapp"};
        }
        if (isApplePlatform()) {
            parameters = {intentType: EB.Intent.START_ACTIVITY, appName: "testapp"};
        }
        if (isAnyWindowsFamilyPlatform()) {
            parameters = {intentType: EB.Intent.START_ACTIVITY, appName: "rhomobile TestApp/TestApp.exe", data: {}};
        }
        runs(function(){
            EB.Intent.send(parameters, null);
        });
        _result.waitForResponse();
    });
    if (!isApplePlatform()) {
    it('VT328_46 | Start Listening to the background intents using callback without argument', function () {
        ...
        runs(function () {
            ...
            if (isAnyWindowsFamilyPlatform()) {
				...
				parameters = {intentType: EB.Intent.BROADCAST, appName: "MotorolaSolutions EB/EB.exe", data: {myData: "This is broad cast data!" } };
            }
