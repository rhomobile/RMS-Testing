describe("Audio Capture Test", function(){
	...
	var wmCallBack = function (args) {		
		...
		resultDiv.innerHTML = resultDiv.innerHTML+ "<br/>############################";
        	setTimeout(function(){
				//resultDiv.innerHTML = "";	
				resultDiv.innerHTML = "######Now capture your Audio######";				
				EB.AudioCapture.start({}, wmCallBack);
            },32000);
	...
	var androidCallBack = function (args) {		
		...
		resultDiv.innerHTML = resultDiv.innerHTML+ "<br/>############################";
        	setTimeout(function(){
				//resultDiv.innerHTML = "";	
				resultDiv.innerHTML = "######Now capture your Audio######";				
				EB.AudioCapture.start({}, androidCallBack);
            },32000);
	...
	var wmTimeCallBack = function (args) {		
		...
		resultDiv.innerHTML = resultDiv.innerHTML+ "<br/>############################";
        	setTimeout(function(){
				...
				EB.AudioCapture.start({'fileName': "\\Application\\"+filewithTime}, wmTimeCallBack);
            },122000);
	...
	var androidTimeCallBack = function (args) {		
		...
		resultDiv.innerHTML = resultDiv.innerHTML+ "<br/>############################";
        	setTimeout(function(){
				...
				resultDiv.innerHTML = "######Now capture your Audio######";	
				filewithTime = new Date().getTime();
				EB.AudioCapture.start({'fileName': "/sdcard/Application/"+filewithTime}, androidTimeCallBack);
            },122000);
    ...
    it('Continuos audio capture for default duration', function () {
        ...
        runs(function(){
            ...
            EB.AudioCapture.start({'fileName': "AudioStress"}, audioCallBack);
	...
	it('Continuos audio capture with setting all properties', function () {
		...
		if(isDirExists == false){
			EB.RhoFile.makeDir("\\Application");
		}
		runs(function(){
			var resultDiv = document.getElementById('actResult');
            EB.AudioCapture.start({'fileName': "\\Application\\AudioStress", 'maxDuration': 30000}, wmCallBack);
    ...
    it('Continuos audio capture with setting all properties', function () {
		...
		var isDirExists = EB.RhoFile.isDir(dirName);
		if(isDirExists == false){
			EB.RhoFile.makeDir("/sdcard/Application");
		}	
        runs(function(){
			resultDiv = document.getElementById('actResult');
			EB.AudioCapture.start({'fileName': "/sdcard/Application/AudioStress", 'maxDuration': 30000, 'encoder': EB.AudioCapture.ENCODER_AMR_NB}, androidCallBack);
        });
	...
	it('Continuos audio capture with setting fileName with different timestamp', function () {
		...
		runs(function(){
			var resultDiv = document.getElementById('actResult');
            EB.AudioCapture.start({'fileName': "\\Application\\"+filewithTime, 'maxDuration': 120000}, wmTimeCallBack);
    ...
    it('Continuos audio capture with setting fileName with different timestamp', function () {
        ...
        runs(function(){
			resultDiv = document.getElementById('actResult');
			EB.AudioCapture.start({'fileName': "/sdcard/Application/"+filewithTime, 'maxDuration': 120000}, androidTimeCallBack);
        });
