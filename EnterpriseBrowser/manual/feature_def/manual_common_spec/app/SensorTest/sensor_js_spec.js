...
describe("Sensor JS API Test", function() {
	...
	it("VT297-0261 | readData for DeviceOrientation before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_DEVICE_ORIENTATION,makesensorbytype_callback);
           if (sensorType)
           {
    ...
    it("VT297-0271 | readData for Motion before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_MOTION,makesensorbytype_callback);
           if (sensorType)
           {
	...
	it("VT297-0291 | readData for AmbientLight before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_AMBIENT_LIGHT,makesensorbytype_callback);
           if (sensorType)
           {
	...
	it("VT297-0296 | readData for Proximity before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_PROXIMITY,makesensorbytype_callback);
           if (sensorType)
           {
	...
	it("VT297-0301 | readData for ProximityLongRange before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_PROXIMITY_LONG_RANGE,makesensorbytype_callback);
           if (sensorType)
           {
	...
	it("VT297-0306 | readData for Pressure before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_PRESSURE,makesensorbytype_callback);
           if (sensorType)
           {
	...
	it("VT297-0321 | readData for Gravity before start to get read current sensor data |", function() {
        runs(function () {
           ...
           EB.Sensor.makeSensorByType(EB.Sensor.SENSOR_TYPE_GRAVITY,makesensorbytype_callback);
           if (sensorType)
           {
