describe("<system module specs>", function () {
    ...
    if (isApplePlatform()) {
        ...
        it("testString callback", function () {
            ...
            runs(function () {
                EB.GenCallbackTests.testString(reversestring,callbackFunction);
            });
        ...
        it("testBool callback", function () {
            ...
            runs(function () {
                EB.GenCallbackTests.testBool(testValue,callbackFunction);
            });
        ...
        it("testInt callback", function () {
            ...
            runs(function () {
                EB.GenCallbackTests.testInt(testValue,callbackFunction);
            });
        ...
        it("testFloat callback", function () {
            ...
            runs(function () {
                EB.GenCallbackTests.testFloat(testValue,callbackFunction);
            });
        ...
        it("testArray callback", function () {
            ...
            runs(function () {
                EB.GenCallbackTests.testArray(reversed,callbackFunction);
            });
        ...
        it("testHash callback", function () {
            ...
            runs(function () {
                EB.GenCallbackTests.testHash(testhash,callbackFunction);
            });
