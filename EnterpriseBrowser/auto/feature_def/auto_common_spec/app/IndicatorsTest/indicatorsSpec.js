describe("Indicators", function() {
	...
	describe("Battery Diagnostics (MC18 Specific)", function() {
		...
		it ("are able to set and retrieve the tripDuration property (valid values)", function()
		{
			...
			EB.Battery.tripDuration = 15;
			var readValue = EB.Battery.tripDuration;
			expect(readValue).toBe(15);
			
			EB.Battery.tripDuration = 30;
			var readValue = EB.Battery.tripDuration;
			expect(readValue).toBe(30);
			
			//  Value 0 should use the driver default of 45 minutes
			EB.Battery.tripDuration = 0;
			var readValue = EB.Battery.tripDuration;
		...
		it ("are able to set and retrieve the tripDuration property (invalid / unrealistic values)", function()
		{
			...
			EB.Battery.tripDuration = 15;
			EB.Battery.tripDuration = -1;
			var readValue = EB.Battery.tripDuration;
			expect(readValue).toBe(15);
			
			EB.Battery.tripDuration = 999999999;
			var readValue = EB.Battery.tripDuration;
		...
		it ("are able to set and retrieve the averageCurrentConsumption property (valid values)", function()
		{
			...
			EB.Battery.averageCurrentConsumption = 1500;
			var readValue = EB.Battery.averageCurrentConsumption;
			expect(readValue).toBe(1500);
			
			EB.Battery.averageCurrentConsumption = 1250;
			var readValue = EB.Battery.averageCurrentConsumption;
			expect(readValue).toBe(1250);
			
			//  Value 0 should use the running average current consumption
			EB.Battery.averageCurrentConsumption = 0;
			var readValue = EB.Battery.averageCurrentConsumption;
				...
				it ("are able to set and retrieve the averageCurrentConsumption property (invalid / unrealistic values)", function()
		{
			...
			EB.Battery.averageCurrentConsumption = 1500;
			EB.Battery.averageCurrentConsumption = -1;
			var readValue = EB.Battery.averageCurrentConsumption;
			expect(readValue).toBe(1500);
			
			EB.Battery.averageCurrentConsumption = 999999999;
			var readValue = EB.Battery.averageCurrentConsumption;
			expect(readValue).toBe(999999999);
		});		
		
		
		it ("are able to retrieve Battery Diagnostics through asynch callback", function()
		{
			if (!isSupported)
				return;
			...
			var retrievedProps = EB.Battery.batteryDiagnostics();
		...
		it ("will report different Battery Diagnostics if the tripDuration and averageCurrentConsumption are changed", function()
		{
			...
			EB.Battery.tripDuration = parseInt(retrievedProps.batteryCapacityMinutes) + 15;
			EB.Battery.averageCurrentConsumption = 2500;
	...
	xdescribe("Signal JS API", function()
	{	
		beforeEach(function() {
	        this.addMatchers({
	...
	xdescribe("Signal JS->AJAX->RubyAPI", function() {
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	xdescribe("Battery JS API", function(){
		...
		it ("Able to access Battery status synchronously", function()
		{
			if (!isSupported)
				return;
			var batteryStatus = EB.Battery.batteryStatus({});
	...
	xdescribe("Battery JS->AJAX->RubyAPI", function() {
	...
	xdescribe("TODO - Testing the KeyState API in Ruby via AJAX.  ", function() {
