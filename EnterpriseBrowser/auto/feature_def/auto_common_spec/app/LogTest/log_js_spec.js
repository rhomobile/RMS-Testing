...
var customLogFiletest = "file://Application//userlog.txt";
		...
		if ((clientPlatform != EB.System.PLATFORM_WP8) && (clientPlatform != EB.System.PLATFORM_WINDOWS_DESKTOP))
		{
		// Call sendLog()
			...
			runs(function(){
				...
				$.ajax({
					...
					success: function(data) {
						EB.Log.info(data,"TST"); result = true;
					},
				 	dataType: 'json',
