describe('Near Field Communications Auto test cases', function () {
    ...
    describe('EB.NFC.Adapter JS API', function () {
        describe('EB.NFC.Adapter APIs Set Test', function () {
            if (["WINDOWS"].indexOf(EB.System.platform) != -1) {
                describe('Getting supported', function () {
                    it('Should return supported value as BOOLEAN (true or false)', function () {
                        expect(EB.NFC.Adapter.supported).isBoolean();
                    });
                });
            }
            if (["WINDOWS"].indexOf(EB.System.platform) != -1) {
                describe('Getting isActive', function () {
                    it('Should return isActive value as BOOLEAN (true or false)', function () {
                        expect(EB.NFC.Adapter.isActive).isBoolean();
                    });
                });
            }
            if (["WINDOWS"].indexOf(EB.System.platform) != -1) {
                describe('Getting version', function () {
                    it('Should return version value as a string', function () {
                        expect(EB.NFC.Adapter.version).isNotEmptyString();
                    });
                });
            }
        });
    });
    describe('EB.NFC.Record JS API', function () {
        describe('EB.NFC.Record APIs Set Test', function () {
            var recordObj = EB.NFC.Record.create();
            if (["WINDOWS"].indexOf(EB.System.platform) != -1) {
            ...
            if (["WINDOWS"].indexOf(EB.System.platform) != -1) {
                describe('Setting type', function () {
                    it('Should Set type to NDEF_RTD_TEXT using direct calling method', function () {
                        recordObj.type = EB.NFC.Record.NDEF_RTD_TEXT;
                        expect(recordObj.type).toEqual(EB.NFC.Record.NDEF_RTD_TEXT);
                    });
                    ...
                    it('Should Set type to NDEF_RTD_URI using direct calling method', function () {
                        recordObj.type = EB.NFC.Record.NDEF_RTD_URI;
                        expect(recordObj.type).toEqual(EB.NFC.Record.NDEF_RTD_URI);
                    });
                    ...
                    it('Should Set type to NDEF_RTD_GENERAL using direct calling method', function () {
                        recordObj.type = EB.NFC.Record.NDEF_RTD_GENERAL;
                        expect(recordObj.type).toEqual(EB.NFC.Record.NDEF_RTD_GENERAL);
                    });
            ...
            if (["WINDOWS"].indexOf(EB.System.platform) != -1) {
                describe('Setting tnf', function () {
                    it('Should Set tnf to NDEF_TNF_EMPTY using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_EMPTY;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_EMPTY);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_WELL_KNOWN using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_WELL_KNOWN;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_WELL_KNOWN);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_MEDIA using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_MEDIA;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_MEDIA);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_ABSOLUTE_URI using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_ABSOLUTE_URI;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_ABSOLUTE_URI);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_EXTERNAL using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_EXTERNAL;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_EXTERNAL);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_UNKNOWN using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_UNKNOWN;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_UNKNOWN);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_UNCHANGED using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_UNCHANGED;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_UNCHANGED);
                    });
                    ...
                    it('Should Set tnf to NDEF_TNF_ANY_TYPE using direct calling method', function () {
                        recordObj.tnf = EB.NFC.Record.NDEF_TNF_ANY_TYPE;
                        expect(recordObj.tnf).toEqual(EB.NFC.Record.NDEF_TNF_ANY_TYPE);
                    });
