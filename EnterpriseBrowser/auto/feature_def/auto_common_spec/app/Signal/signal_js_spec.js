...
xdescribe("Signal Manual FD  Tests", function () {
...
describe("Signal Edge Case  Tests", function () {
  
	
	if (isAnyButApplePlatform()) {
	
	it("VT298-0003 |Signal showIcon left with -10 |", function () {
          var pos ;
          Rho.SignalIndicator.left = -10;
		  pos = Rho.SignalIndicator.left;
          Rho.SignalIndicators.showIcon({left: -10});
